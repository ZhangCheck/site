...
/***/ function(module, exports, __webpack_require__) {
	...
	//生成日期：Thu Jun 01 2017 15:18:12 GMT+0800 (中国标准时间)
	//请手动创建页面文件 "src/pageArgs/testPage.js"，并填充当前内容
	//创建文件后，浏览路由地址“#/page/testPage",可查看到页面实际效果
	var TestPage = function (_Component) {
	  ...
	  TestPage.prototype.render = function render() {
	...
	TestPage = (0, _component2["default"])("aiForm")(TestPage);

	(0, _jsonp2["default"])("testPage")(function (arg, callback) {
	  callback({
	    "success": true,
	    "data": _react2["default"].createElement(TestPage, { id: 'inst1' })
	  });
	});
