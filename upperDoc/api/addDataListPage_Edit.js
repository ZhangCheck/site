...
/***/ function(module, exports, __webpack_require__) {
	...
	var AddDataListPage_Edit = function (_Component) {
	  (0, _inherits3["default"])(AddDataListPage_Edit, _Component);

	  function AddDataListPage_Edit(props) {
	    (0, _classCallCheck3["default"])(this, AddDataListPage_Edit);
	  ...
	  AddDataListPage_Edit.prototype.onClickCreator = function onClickCreator(values) {
	  ...
	  AddDataListPage_Edit.prototype.componentWillUnmount = function componentWillUnmount() {
	    _global.Global.mark({
	      pageLoader: {
	        inst: {
	          source: ""
	  ...
	  AddDataListPage_Edit.prototype.render = function render() {
	    ...
	    var lastDatalist = _global.Global.getState().framework.lastDatalist;
	    var pageName = lastDatalist && lastDatalist.edit_view.match(/apiName:"(\w*)"/)[1] || 'datalistEditDemo';

	    var creator = {
	      "success": true,
	      "data": [{
	        "title": "DataList编辑页面生成器",
	        "column": 1,
	        "labelCol": 1,
	        "wrapperCol": 23,
	        "showTitle": true,
	  ...
	  return AddDataListPage_Edit;
	}(_react.Component);

	AddDataListPage_Edit = (0, _component2["default"])('pageLoader')(AddDataListPage_Edit);

	(0, _jsonp2["default"])("addDataListPage_Edit")(function (arg, callback) {
	  callback({
	    "success": true,
	    "data": _react2["default"].createElement(AddDataListPage_Edit, { id: 'inst' })
	  });
	});
