...
/***/ function(module, exports, __webpack_require__) {
	...
	var DataListPage = function (_Component) {
		(0, _inherits3["default"])(DataListPage, _Component);

		function DataListPage(props) {
			(0, _classCallCheck3["default"])(this, DataListPage);
		...
		DataListPage.prototype.onClickBt = function onClickBt() {
			_global.Global.mark({
		...
		DataListPage.prototype.render = function render() {
	...
	DataListPage = (0, _component2["default"])('pageDemo')(DataListPage);

	(0, _jsonp2["default"])("pageDemo")(function (arg, callback) {
		callback({
			"success": true,
			"data": _react2["default"].createElement(DataListPage, { id: 'pageDemo_inst' })
		});
	});
