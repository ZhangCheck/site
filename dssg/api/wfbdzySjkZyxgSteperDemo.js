...
/***/ temp = function(module, exports, __webpack_require__) {runed=true;
	...
	var _ConnectDatasourceUpdate = __webpack_require__(1310);
	...
	(0, _jsonp2["default"])("wfbdzySjkZyxgSteperDemo")(function (args, callback) {
	    ...
	    callback({
	        ...
	        "data": {
	            "saveDataApi": {
	                "apiName": "wfbdzySjkZyfbSaveAllData"
	            },
	            "steps": [
	            // {
	            //     "type": "datalist",
	            //     "configStepApi": "wfbdzySjkZyxgStep1",
	            //     "number": "1",
	            //     "name": "选择发布目录",
	            //     "id": "wfbdzySjkZyxgStep1",
	            //     "validate": () => {
	            //         let selected = Global.getState().dataList.wfbdzySjkZyxgStep1.selectedRows
	            ...
	            // },
	            {
	                ...
	                "type": _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(_AiForm2["default"], { config: { apiName: "wfbdzySjkZyxgStep3" } })
	                ),
	                "number": "2",
	                "name": "关联数据表",
	                ...
	                "arg": {
	                    // "detailApi":{apiName:"getWfbdzySjkDetail",body:{id:state.dataList.wfbdzySjk.selectedRows[0],listType:"1",resType:"1"}}
	                    "detailApi": null
	                },
	                "type": "aiForm",
	                ...
	                "validate": function validate() {
	                    ...
	                    _global.Global.mark({ aiForm: { wfbdzySjkZyxgStep5: { values: form.getFieldsValue() } } });
	                    return true;
	                }
	            }, {
	                "type": "aiForm",
	                ...
	                "validate": function validate() {
	                    ...
	                    var values = newState.stepContainer.stepValues;
	                    var apiConfig = (0, _extends3["default"])({}, _interfaces.wfbdzySjkZyfbSaveAllData, { body: (0, _extends3["default"])({}, _interfaces.wfbdzySjkZyfbSaveAllData.body, values) });
	                    return apiConfig;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _css8 = __webpack_require__(1821);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _css2 = __webpack_require__(1786);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _css10 = __webpack_require__(1821);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ConnectDatasourceUpdate = function (_Component) {
	    ...
	    ConnectDatasourceUpdate.prototype.componentDidMount = function componentDidMount() {
	        ...
	        this.props.actions.requestDataDir((0, _extends3["default"])({}, itemInterface, { body: (0, _extends3["default"])({}, itemInterface.body, { id: this.props.glState.dataList[this.props.dataToTableId].selectedRows[0] }) }), this.props.id);
	        this.onResize = this.onResize.bind(this);
	        window.addEventListener('resize', this.onResize);
	    };
	    ...
	    ConnectDatasourceUpdate.prototype.render = function render() {
	        ...
	        return _react2["default"].createElement(
	            ...
	            _global.Global.getState().connectDatasource && _global.Global.getState().connectDatasource.ConnectDatasourceUpdate && _global.Global.getState().connectDatasource.ConnectDatasourceUpdate.showDataSourceDlg && _react2["default"].createElement(
	                _modal2["default"],
	                { title: '\u9009\u62E9\u6570\u636E\u6E90', visible: _global.Global.getState().connectDatasource.ConnectDatasourceUpdate.showDataSourceDlg,
	                    onOk: function () {
	                        var result = state.tableIds && state.tableIds.length > 0;
	                        if (result) {
	                            actions.showDataSourceDlg(id, false);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _css4 = __webpack_require__(1786);
