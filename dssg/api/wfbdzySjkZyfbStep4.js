...
/***/ temp = function(module, exports, __webpack_require__) {runed=true;
	...
	(0, _jsonp2["default"])("wfbdzySjkZyfbStep4")(function (args, callback) {
	    ...
	    var lastStepState = states.dataList.wfbdzySjkZyfbStep0 && states.dataList.wfbdzySjkZyfbStep1;
	    if (!lastStepState) {
	    ...
	    callback({
	        ...
	        "data": [{
	            ...
	            "showTitle": false,
	            "buttonConfigs": {},
	            "data": [{ "name": "资源名称", "type": "input", "field": "resName", "defaultValue": name, "validate": [{ "required": true, "message": '请填写资源名称 !' }] }, { "name": "摘要", "type": "input", props: { type: "textarea", rows: 4 }, "field": "abstracts", "validate": [{ "required": true, "message": '请填写摘要!' }] }, { "name": "要素", "type": "input", "field": "keyword", "validate": [{ "required": true, "message": '请填写要素 !' }] }, { "name": "国家主题分类", "type": "treeSelect", "field": "themeType", dictId: "themeType", dictApi: { apiName: 'flglDataTree', body: { categoryType: 1 } }, "defaultValue": states.dicts.treeSelect.themeType.data.length > 0 ? states.dicts.treeSelect.themeType.data[0].value : "", "placeholder": "请选择..." }, { "name": "部门主题分类", "type": "treeSelect", "field": "departmentType", dictId: "departmentType", dictApi: { apiName: 'flglDataTree', body: { categoryType: 2 } }, "defaultValue": states.dicts.treeSelect.departmentType.data.length > 0 ? states.dicts.treeSelect.departmentType.data[0].value : "", "placeholder": "请选择..." }, { "name": "订阅类型", "type": "text", "field": "dylx", 'defaultValue': '数据库' }, { "name": "数据提供方", "type": "input", "field": "rporgname", "validate": [{ "required": true, "message": '请填写数据提供方 !' }] }, { "name": "数据提供方地址", "type": "input", "field": "address", "validate": [{ "required": true, "message": '请填写数据提供方地址 !' }] }, { "name": "发布原因", "type": "input", "field": "applyReason" }]
	        }]
	    });
	});
