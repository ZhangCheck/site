...
/***/ temp = function(module, exports, __webpack_require__) {runed=true;
	...
	var _css = __webpack_require__(1532);
	    ...
	    callback({
	        ...
	        "data": {
	            ...
	            "steps": [{
	                ...
	                "arg": {
	                    detailMsg: (0, _extends3["default"])({}, _interfaces.dyspWjDetail, { body: (0, _extends3["default"])({}, _interfaces.dyspWjDetail.body, { listType: 5, resType: 2, id: _global.Global.getState().dataList.dyspWj.selectedRows[0], equipment: subEupment }) })
	                },
	                "number": "1",
	                "name": "查看订阅申请",
	                "id": "dyspWjDyspStep1",
	                ...
	                "validate": function validate() {
	                    ...
	                    var apiConfig = (0, _extends3["default"])({}, _interfaces.dyspSaveAllData, {
	                        body: (0, _extends3["default"])({}, _interfaces.dyspSaveAllData.body, { resourceId: _global.Global.getState().dataList.dyspWj.selectedRows[0], approvalOpinion: _global.Global.getState().aiForm.dyspWjDyspStep1.reviewDesc, result: _global.Global.getState().aiForm.dyspWjDyspStep1.result, subSendEquipment: subSendEquipment, dbProcessStrategyJson: {}
	                        })
	                    });
	                    return apiConfig;
	                }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _css2 = __webpack_require__(1532);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _css4 = __webpack_require__(1532);
