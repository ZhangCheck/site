...
/***/ temp = function(module, exports, __webpack_require__) {runed=true;
	...
	(0, _jsonp2["default"])("wdydzyapizyck")(function (args, callback) {
	    var srcscolumns = [{
	        "title": "参数",
	    ...
	    callback({
	        ...
	        "data": [{
	            ...
	            "wrapperCol": 16, //form显示框宽度
	            "showTitle": true, //是否展示栏目标题
	            "data": [{ "name": "接口地址", "type": "text", "field": "fbyy", "defaultValue": "内容是未知的" }, { "name": "服务类型", "type": "text", "field": "sqr", "defaultValue": "内容是未知的" }, { "name": "方法", "type": "text", "field": "sqr", "defaultValue": "内容是未知的" }, { "name": "接口文档", "type": "text", "field": "fbyy", "defaultValue": "内容是未知的" }]
	        }, {
	            "title": "API共享等级", //栏目标题
	            "column": 2, //  form显示列数，首先读取每个标签的设置column值，不存在才会读取总的column,如果不存在，默认展示一列
	            "labelCol": 8, // form标头name宽度
