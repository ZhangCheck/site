...
/***/ temp = function(module, exports, __webpack_require__) {runed=true;
	...
	(0, _jsonp2["default"])("sjkcxdy")(function (args, callback) {
	    var dyyhcolumns = [{
	        "title": "订阅用户",
	        "dataIndex": "dyyh",
	        "key": "dyyh"
	    ...
	    callback({
	        ...
	        "data": [{
	            ...
	            "wrapperCol": 16, //form显示框宽度
	            "showTitle": true, //是否展示栏目标题
	            "data": [{ "name": "撤销原因", "type": "text", "field": "cxyy", "defaultValue": "内容是未知的" }, { "name": "申请人", "type": "text", "field": "sqr", "defaultValue": "内容是未知的" }]
	        }]
	    });
	});
