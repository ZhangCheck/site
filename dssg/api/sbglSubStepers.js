	    ...
	    callback({
	        ...
	        "data": {
	            ...
	            "steps": [{
	                ...
	                "id": "sbglSubStep2",
	                "validate": function validate() {
	                    var form = _global.Global.getState().aiForm.sbglSubStep2.form;
	                    var validate = false;
	                ...
	                "validate": function validate() {
	                    ...
	                    if (validate) {
	                        ...
	                        _global.Global.requestApi({ apiName: 'sbIpMes' }, { aiForm: { sbIpMes: null } });
	                    }
	                    return validate;
	                }
	            }, {
	                ...
	                "name": "下载设备证书",
	                "id": "sbglSubStep4",
	                "footer": ['prev', function () {
	                    return _react2["default"].createElement(
	                        _button2["default"],
	                        { type: 'primary', onClick: function onClick() {
	                                var url = $(server) + "fileUpload/downloadModleFile?filename=" + "sss";
	                                if (typeof window.dlFrame == "undefined") {
	                                    window.dlFrame = document.createElement("iframe");
	                                    document.body.appendChild(window.dlFrame);
	                                }
	                                window.dlFrame.src = url;
	                                window.dlFrame.style.display = "none";
	                            } },
	                        '\u4E0B\u8F7D\u8BC1\u4E66'
	                    );
	                }, 'next'],
	                "validate": function validate() {
	                    ...
	                    var step3Datas = state.aiForm.sbglSubStep3.values;
	                    var apiConfig = (0, _extends3["default"])({}, _interfaces.sbglRegisterDatas, { body: (0, _extends3["default"])({}, _interfaces.sbglRegisterDatas.body, { step3Datas: step3Datas }) });
	                    return apiConfig;
	                }
	            }]
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _css = __webpack_require__(1631);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _css10 = __webpack_require__(1621);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _css4 = __webpack_require__(1631);
