...
/***/ temp = function(module, exports, __webpack_require__) {runed=true;
	...
	(0, _jsonp2["default"])("wfbdzyApiDsfjjkSteperDemo")(function (args, callback) {
	    ...
	    var list = states.aiForm.wfbdzyApiDsfjkTxysjStep1;
	    var step = states.stepContainer.wfbdzyApiDsfjjkSteperDemo.step;
	    if (!list && step != 1) {
	        _StepContainerV2["default"].gotoFirst('wfbdzyApiDsfjkTxysjStep1');
	    }
	    callback({
	        "success": true,
	        "data": {
	            ...
	            "steps": [{
	                ...
	                "validate": function validate() {
	                    var form = _global.Global.getState().aiForm.wfbdzyApiDsfjkTxysjStep1.form;
	                    var validate = false;
	                ...
	                //"footer":['prev','next'],
	                "validate": function validate() {
	                    var form = _global.Global.getState().aiForm.wfbdzyApiDsfjkTxurlStep2.form;
	                    if (_global.Global.getState().aiForm.message && _global.Global.getState().aiForm.message.data == true) {
	                ...
	                // "footer":['prev','next'],
	                "validate": function validate() {
	                    var apiConfig = (0, _extends3["default"])({}, _interfaces.wfbdzyApiDsfjkAllSaveAllData, {
