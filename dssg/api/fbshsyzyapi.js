...
/***/ temp = function(module, exports, __webpack_require__) {runed=true;
	...
	var _css = __webpack_require__(1549);
	    ...
	    callback({
	        ...
	        "data": {
	                            ...
	                            _react2["default"].createElement(
	                                ...
	                                _react2["default"].createElement(
	                                    ...
	                                    { onClick: function onClick() {
	                                            ...
	                                            var result2 = (0, _dataFormat.checkTableOneData)(_global.Global, "fbshsyzyapi", "state", "2");
	                                            if (!result2) {
	                                                _modal2["default"].warning({
	                                                    content: '资源已发布！'
	                                                });
	            ...
	            "searchConfig": {
	                "data": [{
	                    "column": 6,
	                    "data": [{ "type": "input", "col": 6, "name": "资源名称", "field": "resName" }, { "type": "treeSelect", "col": 7, "name": "主题分类", "field": "themeType", options: { value: "_all_", key: "全部" }, dictId: "themeType", dictApi: { apiName: 'flglDataTree', body: { categoryType: 1 } } }, { "type": "select", "col": 4, "name": "状态", "field": "state", options: [{ value: "_all_", key: "全部" }, { value: "1", key: "待审核" }, { value: "2", key: "发布" }, { value: "3", key: "发布拒绝" }] }, { "type": "select", "col": 5, "name": "申请时间", "field": "applyTime", options: [{ value: "_all_", key: "全部" }, { value: "1", key: "最近一周" }, { value: "2", key: "最近一月" }, { value: "3", key: "最近三月" }, { value: "4", key: "最近一年" }] }, { "type": "button", "col": 2, "value": "查询", "pageName": "search", "btnType": "primary", "htmlType": "submit" }]
	                }],
