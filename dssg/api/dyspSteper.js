...
/***/ temp = function(module, exports, __webpack_require__) {runed=true;
	...
	(0, _jsonp2["default"])("dyspSteper")(function (args, callback) {
	    var dataSource = _global.Global.getState().dataList.dysp ? _global.Global.getState().dataList.dysp.tableBodyDataApi.data.content : [];
	    var sub_SEND_EQUIPMENT = void 0;
	    dataSource.forEach(function (item) {
	        if (_global.Global.getState().dataList.dysp.selectedRows[0] == item.id) {
	            sub_SEND_EQUIPMENT = item.sub_SEND_EQUIPMENT;
	        }
	    });
	    ...
	    callback({
	        ...
	        "data": {
	            ...
	            "steps": [{
	                ...
	                "arg": {
	                    detailMsg: (0, _extends3["default"])({}, _interfaces.dyspDetail, { body: (0, _extends3["default"])({}, _interfaces.dyspDetail.body, { listType: 5, resType: 1, equipment: sub_SEND_EQUIPMENT, id: _global.Global.getState().dataList.dysp ? _global.Global.getState().dataList.dysp.selectedRows : null }) })
	                },
	                "number": "1",
	                "name": "查看订阅申请",
	                "id": "getDyspEdit",
	                ...
	                "arg": {
	                    detailMsg: (0, _extends3["default"])({}, _interfaces.dyspDetail, { body: (0, _extends3["default"])({}, _interfaces.dyspDetail.body, { listType: 5, resType: 1, equipment: sub_SEND_EQUIPMENT, id: _global.Global.getState().dataList.dysp.selectedRows }) })
	                },
	                "number": "3",
	                "name": "发布预览",
	                "id": "dyspSjkFbyl",
	                "validate": function validate() {
	                    var apiConfig = (0, _extends3["default"])({}, _interfaces.dyspSaveAllData, {
	                        body: (0, _extends3["default"])({}, _interfaces.dyspSaveAllData.body, _global.Global.getState().aiForm.dyspSjkFbyl.values, { subSendEquipment: sub_SEND_EQUIPMENT }) });
	                    return apiConfig;
	                }
	            }]
	        }
