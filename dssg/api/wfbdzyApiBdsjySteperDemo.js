	    ...
	    callback({
	        ...
	        "data": {
	            ...
	            "steps": [{
	                ...
	                "type": _react2["default"].createElement(_ConnectDatasourceApi2["default"], { id: 'connectDataSourceApi', dataSourceApiName: { apiName: "getTableFields" }, allConfigs: { apiName: "viewTableWfbdzyApiConfig" }, getTablesInfo: { apiName: "getAddTableData" }, dataFormTableId: 'wfbdzyApiBdsjyXzsjyStep1', configs: { apiName: "getDataItemContent" } }),
	                "configStepApi": "",
	                "number": "2",
	                "name": "关联数据表",
	                //"footer":['prev','next'],
	                ...
	                //"footer":['prev','next'],
	                "validate": function validate() {
	                    var apiConfig = (0, _extends3["default"])({}, _interfaces.wfbdzyApiBdsjyAllSaveAllData, {
	                        body: (0, _extends3["default"])({}, _interfaces.wfbdzyApiBdsjyAllSaveAllData.body, _global.Global.getState().aiForm.wfbdzyApiBdsjyFbylStep7.values) });
	                    return apiConfig;
	                }
	            }]
	        }
