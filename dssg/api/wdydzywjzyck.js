	...
	(0, _jsonp2["default"])("wdydzywjzyck")(function (args, callback) {
	    ...
	    callback({
	        ...
	        "data": [{
	            ...
	            "showTitle": true,
	            "titleIcon": "user",
	            "data": _react2["default"].createElement(_Dyyh2["default"], { id: 'bottomData3', zyckId1: 'wdydzywjzyck', zyckId: 'wdydzyWj', bottomRequest: 'false' })
	        }, {
	            "title": "资源订阅信息",
	            "column": 2,
	            "showTitle": true,
	            ...
	            "data": [{ "name": "申请订阅原因", "type": "text", "field": "fbyy", "defaultValue": resSubscribeDTO ? resSubscribeDTO.applyReason : "" }, { "name": "申请人", "type": "text", "field": "sqr", "defaultValue": resSubscribeDTO ? resSubscribeDTO.applyPerson : "" }, { "name": "申请订阅时间", "type": "text", "field": "sqr", "defaultValue": resSubscribeDTO ? resSubscribeDTO.applyTime : "" }, { "name": "审批结果", "type": "text", "field": "fbyy", "defaultValue": resSubscribeDTO ? resSubscribeDTO.state == "1" ? "通过" : resSubscribeDTO.state == "2" ? "拒绝" : "处理中" : "" }, { "name": "审批意见", "type": "text", "field": "fbyy", "defaultValue": resSubscribeDTO ? resSubscribeDTO.approvalOpinion : "" }, { "name": "审批时间", "type": "text", "field": "sqr", "defaultValue": resSubscribeDTO ? resSubscribeDTO.approvalTime : "" }]
	        }]
	    });
	});
