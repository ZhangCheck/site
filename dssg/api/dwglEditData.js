...
/***/ temp = function(module, exports, __webpack_require__) {runed=true;
	...
	(0, _jsonp2["default"])("dwglEditData")(function (args, callback) {
	    var target = args.target;
	    var detailValue = [];
	    var values = Global.getState().dataList.dwgl.detailMsgDataApi && Global.getState().dataList.dwgl.detailMsgDataApi.data ? Global.getState().dataList.dwgl.detailMsgDataApi.data : {};
	    if (args.type == "add") {
