	    ...
	    callback({
	        ...
	        "data": {
	            ...
	            "searchConfig": {
	                "data": [{
	                    "column": 6,
	                    "data": [{ "type": "input", "col": 7, "name": "资源名称/编码", "field": "zymcbm" }, { "type": "select", "col": 5, "name": "主题分类", "dictId": "ztfl", "field": "ztfl" }, { "type": "select", "col": 5, "name": "状态", "dictId": "zt", "field": "zt" }, { "type": "select", "col": 5, "name": "订阅时间", "dictId": "fbsj", "field": "fbsj" }, { "type": "button", "col": 1, "value": "查询", "pageName": "search", "btnType": "primary", "htmlType": "submit" }, { "type": "treeSelect", style: { visibility: "hidden" }, col: 1, "field": "departmentType", dictId: "departmentType", dictApi: { apiName: 'flglDataTree', body: { categoryType: 2 } } }]
	                }],
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _css = __webpack_require__(1682);
