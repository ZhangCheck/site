...
/***/ temp = function(module, exports, __webpack_require__) {runed=true;
	...
	var _css = __webpack_require__(1824);
	    ...
	    callback({
	        ...
	        "data": {
	            ...
	            "searchConfig": {
	                "data": [{
	                    "column": 6,
	                    "data": [{ "type": "input", "col": 7, "name": "目录名称/编码", "field": "resName" }, { "type": "treeSelect", "col": 5, "name": "主题分类", "field": "themeType", options: { value: "_all_", key: "全部" }, dictId: "themeType", dictApi: { apiName: 'flglDataTree', body: { categoryType: 1 } } }, { "type": "select", "col": 5, "name": "目录状态", "field": "state", options: [{ value: "_all_", key: "全部" }, { value: "1", key: "待审核" }, { value: "2", key: "发布" }, { value: "3", key: "发布拒绝" }] }, { "type": "select", "col": 5, "name": "目录分类", "field": "state", options: [{ value: "_all_", key: "全部" }, { value: "1", key: "共享目录" }, { value: "2", key: "采集目录" }, { value: "3", key: "开放目录" }] }, { "type": "button", "col": 2, "value": "查询", field: "button", "pageName": "search", "btnType": "primary", "htmlType": "submit" }]
	                }],
