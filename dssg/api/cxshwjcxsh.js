...
/***/ temp = function(module, exports, __webpack_require__) {runed=true;
	...
	(0, _jsonp2["default"])("cxshwjcxsh")(function (args, callback) {
	    ...
	    var processRecordDTO = datas ? datas.processRecordDTO : {};
	    ...
	    callback({
	        ...
	        "data": [{
	            ...
	            "buttonConfigs": {
	                ...
	                "buttons": [{ "type": "button", "value": "返回", "field": "back", props: { btnType: "primary", "style": { "float": "right" } } }, { "type": "button", "value": "撤销审核", "field": "submit", props: { btnType: "primary", "style": { "float": "right" } } }]
	            },

	            "data": [{ "name": "撤销原因", "type": "input", "field": "reviewDesc", "defaultValue": "" }, { "name": "审批结果", "type": "select", "field": "result", "options": [{ value: "0", key: "通过" }, { value: "-1", key: "拒绝" }] }, { "name": "申请人", ignore: "ignore", "type": "text", "field": "sqr", "defaultValue": processRecordDTO.applyUser }]
	        }]
	    });
	});
