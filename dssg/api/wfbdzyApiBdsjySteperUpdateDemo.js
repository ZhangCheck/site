...
/***/ temp = function(module, exports, __webpack_require__) {runed=true;
	...
	var _css2 = __webpack_require__(1722);
	...
	var _ConnectDatasourceApi = __webpack_require__(1308);

	var _ConnectDatasourceApi2 = _interopRequireDefault(_ConnectDatasourceApi);

	var _ConnectDatasourceApiUpdate = __webpack_require__(1309);
	        ...
	        "data": {
	            ...
	            "steps": [{
	                ...
	                "validate": function validate() {
	                    ...
	                    var dataSource = (0, _dataFormat.aiFormTableValue)(form.getFieldsValue());
	                ...
	                "validate": function validate() {
	                    var state = _global.Global.getState();
	                    if (!state.connectDatasource.connectDataSourceApi.outIndexs) {
	                        _modal2["default"].warning({
	                            content: "请选择输出参数！"
	                        });
	                        return false;
	                ...
	                "validate": function validate() {
	                    ...
	                    if (validate) {
	                        _global.Global.mark({ aiForm: { wfbdzyApiBdsjyTxysjStep5: { values: form.getFieldsValue() } } });
	                    }
	                    return validate;
	                }
	            }, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _css8 = __webpack_require__(1730);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _css10 = __webpack_require__(1730);
	                                        ...
	                                        text = new _Text2["default"]({
	                                            ...
	                                            onclick: function onclick() {
	                                                if (clickNum == 0) {
	                                                    ...
	                                                    for (var p in data) {
	                                                        if (p == "name") {
	                                                            data[p + '_field'] = p + "_field" + "_" + (data.index - 1);
	                                                    ...
	                                                    if (dataPara.length > 0) {
	                                                        dataPara.map(function (data, i) {
	                                                            names.push(data.table + "." + data.showName);
	                                                        });
	                                                        if (names.indexOf(data.table + "." + data.showName) < 0) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ConnectDatasourceApiUpdate = function (_Component) {
	    ...
	    ConnectDatasourceApiUpdate.prototype.render = function render() {
	        ...
	        var rowSelection = {
	            type: this.props.mode == 'api' ? 'radio' : 'checkbox',
	            selectedRowKeys: states.connectDatasource && states.connectDatasource.connectDataSourceApi && states.connectDatasource.connectDataSourceApi.selectKeys ? states.connectDatasource.connectDataSourceApi.selectKeys : [],
	            onChange: function onChange(selectedRowKeys, selectedRows) {
	                console.log(selectedRowKeys, selectedRows);
	                var tableName = [];
	                selectedRows.forEach(function (item, index) {
	        ...
	        return _react2["default"].createElement(
	            'div',
	            null,
	            state && actions && state.requestTables && state.requestTables.data && state.requestTables.data.content && (!state.tableIds || state.tableIds.length == 0) && _react2["default"].createElement(
	                'div',
	                { style: { textAlign: 'center', paddingTop: 30 } },
	                _react2["default"].createElement(
	                    _button2["default"],
	            ...
	            state && state.tableIds && state.tableIds.length > 0 && !state.showDataSourceDlg && state.getContentByTableTile && state.getContentByTableTile.data && state.getContentByTableTile.data.length > 0 && _react2["default"].createElement(
	                'div',
	                { id: 'cavas', style: { width: "100%", height: 300 }, ref: function (dom) {
	                        _this2.canvas = dom;
	                        if (_this2.zr || !dom) return; //this.zr.dispose();
	                        ...
	                        var onMouseDown = function onMouseDown(e) {
	                            ...
	                            ox = moveTarget.position[0];
	                            oy = moveTarget.position[1];
	                            if (this.stage && this.stage.moving) {
	                        ...
	                        var onMouseMove = function onMouseMove(e) {
	                            if (dx != null) {
	                                ...
	                                moveTarget.position[1] = oy + vy;
	                                moveTarget.dirty(true);
	                                if (moveTarget.type == "table" && this.props && this.props.state.linkdatas && this.props.state.linkdatas.length > 0) {
	                                    //actions.updateLine(id);
	                                    var _iteratorNormalCompletion2 = true;
	                                    var _didIteratorError2 = false;
	                                    var _iteratorError2 = undefined;
	                                    ...
	                                    try {
	                                        for (var _iterator2 = (0, _getIterator3["default"])(this.props.state.linkdatas), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	                                            var link = _step2.value;

	                                            if (this.lineMap[link.id]) {
	                                                var leftZField = void 0,
	                                                    rightZField = void 0;
	                                                if (link.from.zField.parent.position[0] < link.to.zField.parent.position[0]) {
	                                                    leftZField = link.from.zField;
	                        ...
	                        editBtn.on('click', function () {
	                            actions.mark(id, { currentLink: this.overLink, linkType: this.props.state.linkdatas[this.overLink].linkType, showConnectDlg: true });
	                            this.editBtns.hide();
	                        }.bind(_this2));
	                        editBtns.add(editBtn);
	                        ...
	                        delBtn.on('click', function () {
	                            actions.mark(id, { currentLink: this.overLink });
	                            this.editBtns.hide();
	                            actions.delLink(id);
	                        }.bind(_this2));
	                        editBtns.add(delBtn);
	            ...
	            state && state.tableIds && state.tableIds.length > 0 && state.getContentByTableTile && state.getContentByTableTile.data && state.getContentByTableTile.data.length > 0 && _react2["default"].createElement(_AiForm2["default"], { config: { apiName: this.props.allConfigs.apiName }, id: 'viewTableApiDemo1' })
	        );
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _css4 = __webpack_require__(1722);
