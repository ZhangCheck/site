	            ...
	            "steps": [{
	                ...
	                "validate": function validate() {
	                    ...
	                    var apiConfig = (0, _extends3["default"])({}, _interfaces.wfbdzyFilePublishResource, {
	                        body: (0, _extends3["default"])({}, _interfaces.wfbdzyFilePublishResource.body, { themeTypeName: themeTypeName, departmentTypeName: departmentTypeName, themeType: themeType, departmentType: departmentType, dataSourceId: step1SelectRowsId, fileDataJson: step2SelectDatas, dispatchStrategy: dispatchStrategy, resLevel: fileLevel, metadataDTO: metadataDTO
	                        })
	                    });
	                    return apiConfig;
	                }
