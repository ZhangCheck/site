...
/***/ temp = function(module, exports, __webpack_require__) {runed=true;
	...
	(0, _jsonp2["default"])("dwglList")(function (args, callback) {
	    ...
	    callback({
	        ...
	        "data": {
	            "id": "dwgl",
	            "title": "这是formTable页面！！！！！",
	            "buttonConfigs": [{ "buttonName": "add", type: "add" }, { "buttonName": "delete" }, { "buttonName": "edit" }, { "buttonName": "direction", "act": "up", "icon": "up", "value": "上移" }, { "buttonName": "direction", "act": "down", "icon": "down", "value": "下移" }, { "buttonName": "direction", "act": "upgrade", "icon": "arrow-left", "value": "升级" }, { "buttonName": "direction", "act": "downgrade", "icon": "arrow-right", "value": "降级" }],
	            "searchConfig": {
	                "data": [{
	                    "column": 4,
	                    "data": [{ "type": "input", col: 8, "name": "单位名称", "field": "name" }, { "type": "select", col: 7, "name": "单位级别", "field": "level", "options": [{ key: "全部", value: "_all_" }, { key: "一级", value: "1" }, { key: "二级", value: "2" }, { key: "三级", value: "3" }] }, { "type": "button", col: 4, "value": "查询", "pageName": "search", "btnType": "primary", "htmlType": "submit" }]
	                }],
	                "body": { apiName: 'dwglData' }
	            },
	            "table": {
	                "primarykey": "id",
	                "clounms": [{
	            ...
	            "add": {
	                "initData": {
	                    data: { apiName: "getDwglEdit" }
	                },
	                "onAddSubmitApi": { "apiName": "dwglAddInfo" }
	            },
	            "edit": {
	                "initData": {
	                    data: { apiName: "getDwglEdit" }
	                },
	                "onUpdateSubmitApi": { "apiName": "dwglEditInfo" }
	            },
	            "delete": {
	                "body": { apiName: 'deletedwglInfo' }
	            },
	            "detail": {
	                "body": { apiName: 'dwglDetail' }
	            },
	            "check": {
	                "view": null,
	                "checkApi": null
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _css = __webpack_require__(1506);
