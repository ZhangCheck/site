	...
	(0, _jsonp2["default"])("sbglStep2")(function (args, callback) {
	    ...
	    callback({
	        ...
	        "data": [{
	            ...
	            "showTitle": true,
	            "titleIcon": "copy",
	            "data": [{ "name": "设备名称", "type": "input", "field": "equipmentName", "validate": [{ "required": true, "message": '请填写设备名称' }] }, { "name": "单位名称", "type": "treeSelect", "field": "unitName", dictId: "unitName", "placeholder": "请选择...", dictApi: { apiName: 'flglDataTree', body: { categoryType: 1 } } }, { "name": "联系人", "type": "input", "field": "person", "validate": [{ "required": true, "message": '请填写联系人' }] }, { "name": "联系电话", "type": "input", "field": "telephone", "validate": [{ "required": true, "message": '请填写联系电话' }] }, { "name": "邮箱", "type": "input", "field": "email", "validate": [{ "required": true, "message": '请填写邮箱' }] }, { "name": "单位地址", "type": "input", "field": "address", "validate": [{ "required": true, "message": '请填写地址' }] }, { "name": "所属业务条线", "type": "treeSelect", "field": "ssywzx", dictId: "ssywzx", "placeholder": "请选择...", dictApi: { apiName: 'flglDataTree', body: { categoryType: 1 } } }, { "name": "所属行政层级", "type": "treeSelect", "field": "ssxzcj", dictId: "ssxzcj", "placeholder": "请选择...", dictApi: { apiName: 'flglDataTree', body: { categoryType: 1 } } }]
	        }]
	    });
	});
