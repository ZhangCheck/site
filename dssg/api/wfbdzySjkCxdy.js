	        ...
	        callback({
	            ...
	            "data": [{
	                ...
	                "data": function data() {
	                    ...
	                    return _react2["default"].createElement(_table2["default"], { rowSelection: rowSelection, columns: dyyhCloumn,
	                            ...
	                            type: "primary", "style": { "float": "right" }, onClick: function onClick() {
	                                ...
	                                if (ids) {
	                                    _global.Global.requestApi({
	                                        ...
	                                        next: function next() {
	                                            var result = _global.Global.getState().dataList.wfbdzySjkCxdy.wfbdzySjkCxdyResult;
	                                            if (result) {
	                                                ...
	                                                _history2["default"].push('#/datalist/list/wfbdzySjk/0/10');
	                                            } else {
	                                    ...
	                                    }, ['requestSjkCXDY', 'receieveSjkCXDY', 'failedSjkCXGX'], { dataList: { wfbdzySjkCxdy: { wfbdzySjkCxdyResult: null } } });
	                                } else {
	                                    _modal2["default"].warning({
	                                        title: '提示',
	                                        content: '请选择撤销的用户'
