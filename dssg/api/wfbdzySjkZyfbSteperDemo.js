	...
	(0, _jsonp2["default"])("wfbdzySjkZyfbSteperDemo")(function (args, callback) {
	    callback({
	        ...
	        "data": {
	            ...
	            "steps": [{
	                "type": "datalist",
	                "configStepApi": "wfbdzySjkZyfbStep0",
	                "number": "1",
	                "name": "选择发布目录",
	                "id": "wfbdzySjkZyfbStep0",
	                "footer": ["next"],
	                "validate": function validate() {
	                    var selected = _global.Global.getState().dataList.wfbdzySjkZyfbStep0.selectedRows;
	                ...
	                "validate": function validate() {
	                    var selected = _global.Global.getState().dataList.wfbdzySjkZyfbStep1.selectedRows;
	                    var validate = selected && selected.length > 0;
	                    var result = _global.Global.getState().dataList.wfbdzySjkZyfbSteperDemo ? _global.Global.getState().dataList.wfbdzySjkZyfbSteperDemo.data : undefined;
	                    if (!validate) {
	                        if (result) {
	                            _modal2["default"].warning({
	                                title: '提示',
	                ...
	                "type": _react2["default"].createElement(_ConnectDatasource2["default"], { id: 'connectDataSourceDemo',
	                    ...
	                    dataFormTableId: 'wfbdzySjkZyfbStep1', dataFromId: 'wfbdzySjkZyfbStep0',
	                ...
	                "validate": function validate() {
	                    ...
	                    if (result1 && result1.length >= 2) {
	                        ...
	                        if (tableNames && (0, _dataFormat.unique)(tableNames).length > 0 && (0, _dataFormat.unique)(tableNames).length < 2) {
	                            _modal2["default"].warning({
	                                title: '提示',
	                    ...
	                    if (!result) {
	                        ...
	                        var forms = _global.Global.getState().aiForm.viewTableDemo1.form.getFieldsValue();
	                        if (forms.columnName_field_0) {
	                            validate = !validate;
	                        } else {
	                            _modal2["default"].warning({
	                                title: '提示',
	                ...
	                "type": "aiForm",
	                "configStepApi": "wfbdzySjkZyfbStep4",
	                "number": "4",
	                "name": "填写元数据信息",
	                "id": "wfbdzySjkZyfbStep4",
	                "footer": ["prev", "next"],
	                "validate": function validate() {
	                    var form = _global.Global.getState().aiForm.wfbdzySjkZyfbStep4.form;
	                    var validate = false;
	                    form.validateFields(function (fileds) {
	                        validate = !fileds;
	                    });
	                    if (validate) {
	                        _global.Global.mark({ aiForm: { wfbdzySjkZyfbStep4: { values: form.getFieldsValue() } } });
	                    }
	                    return validate;
	                }
	            }, {
	                ...
	                "validate": function validate() {
	                    ...
	                    var apiConfig = (0, _extends3["default"])({}, _interfaces.wfbdzySjkZyfbSaveAllData, {
	                        body: (0, _extends3["default"])({}, _interfaces.wfbdzySjkZyfbSaveAllData.body, values)
	                    });
	                    return apiConfig;
