	...
	(0, _jsonp2["default"])("wfbdzyFileZyck")(function (args, callback) {
	    ...
	    callback({
	        ...
	        "data": [{
	            ...
	            "data": [{ "name": "发布原因", "type": "text", "field": "reason", "defaultValue": processRecordDTO.applyReason }, { "name": "申请人", "type": "text", "field": "applyUser", "defaultValue": processRecordDTO.applyUser }, { "name": "申请时间", "type": "text", "field": "applyTime", "defaultValue": processRecordDTO.applyTime }, { "name": "审核结果", "type": "text", "field": "result", "defaultValue": processRecordDTO.result == null ? " " : processRecordDTO.result == "0" ? "通过" : "拒绝" }, { "name": "审核意见", "type": "text", "field": "reviewDesc", "defaultValue": processRecordDTO.reviewDesc }, { "name": "审核时间", "type": "text", "field": "reviewTime", "defaultValue": processRecordDTO.reviewTime }]
	        }]
	    });
	});
