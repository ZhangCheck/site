...
/***/ temp = function(module, exports, __webpack_require__) {runed=true;
	...
	(0, _jsonp2["default"])("flglEditLocalData")(function (args, callback) {
	    var target = args.target;
	    var values = _global.Global.getState().dataList.flglLocal.detailMsgDataApi && _global.Global.getState().dataList.flglLocal.detailMsgDataApi.data ? _global.Global.getState().dataList.flglLocal.detailMsgDataApi.data : {};
	    var detailValue = [];
	    if (args.type == "add") {
	    ...
	    callback({
	        ...
	        "data": [{
	            ...
	            "showTitle": true,
	            "buttonConfigs": {
	                "buttons": [{ "type": "button", "value": "返回", mark: "flglLocal", "field": "back", props: { btnType: "primary", "style": { "float": "right" } } }, { "type": "button", "value": "确定", mark: "flglLocal", "field": "submit", props: { "style": { "float": "right" }, htmlType: "submit" } }]
	            },
