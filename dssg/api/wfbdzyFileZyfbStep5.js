...
/***/ temp = function(module, exports, __webpack_require__) {runed=true;
	...
	var _css3 = __webpack_require__(1768);
	...
	(0, _jsonp2["default"])("wfbdzyFileZyfbStep5")(function (args, callback) {
	    ...
	    var ysjBasicInf = state.aiForm.wfbdzyFileZyfbStep3 ? state.aiForm.wfbdzyFileZyfbStep3.values : "";
	    var step2 = state.dataList.wfbdzyFileZyfbStep2 ? state.dataList.wfbdzyFileZyfbStep2 : "";
	    ...
	    //更新策略
	    var step4Values = state.aiForm.wfbdzyFileZyfbStep4 && state.aiForm.wfbdzyFileZyfbStep4.values ? state.aiForm.wfbdzyFileZyfbStep4.values : "";
	    var ddModelDatas = [];
	    ...
	    callback({
	        ...
	        "data": [{
	            ...
	            "titleIcon": "catalog",
	            "data": function data() {
	                return _react2["default"].createElement(_table2["default"], { columns: gxwjxxcolumns, dataSource: step2SelectDatas, bordered: true, pagination: false });
	            }
	        }, {
	            "title": "更新策略",
	            "showTitle": true,
	            ...
	            "data": function data() {
	                return _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(_table2["default"], { columns: step4Values.ddModel == 1 ? gxclCloumn_zq : gxclCloumn_dq, dataSource: ddModelDatas, bordered: true, pagination: false })
	                );
	            }
	        }, {
	            "title": "文件共享等级",
	            ...
	            "data": [{ "name": "发布原因", "labelCol": 12, "wrapperCol": 12, "type": "text", "field": "applyReason", "defaultValue": ysjBasicInf.applyReason }, { "name": "申请人", "labelCol": 12, "wrapperCol": 12, "type": "text", "field": "proposer", "defaultValue": state.framework.loginApi.data.loginUserProfileDTO && state.framework.loginApi.data.loginUserProfileDTO.loginName ? state.framework.loginApi.data.loginUserProfileDTO.loginName : "" }]
	        }]
	    });
	});
