...
/***/ temp = function(module, exports, __webpack_require__) {runed=true;
	...
	var _css2 = __webpack_require__(1799);
	...
	(0, _jsonp2["default"])("wfbdzySjkZyfbStep5")(function (args, callback) {
	    ...
	    var config = {
	        ...
	        "data": [{
	            ...
	            "titleIcon": "copy",
	            "wrapperCol": 6,
	            "data": [{ "name": "调度模式", "type": "select", "field": "ddModel", "defaultValue": 1, "placeholder": "请选择...", "options": [{ value: 1, key: "周期模式" }, { value: 2, key: "定期模式" }] }, { "name": "开始时间", "field": "startTime", "type": "datePicker", "defaultValue": "", props: { showTime: true },
	                preRender: function preRender() {
	                    return _global.Global.getState().aiForm.wfbdzySjkZyfbStep5.form.getFieldValue('ddModel') == 2 ? "hidden" : "";
	                }
	            }, { "dictId": 'timeType1',
	                preRender: function preRender() {
	                    return _global.Global.getState().aiForm.wfbdzySjkZyfbStep5.form.getFieldValue('ddModel') == 2 ? "hidden" : "";
	                ...
	                "value": function value(config) {
	                    return _react2["default"].createElement(
	                        ...
	                        _global.Global.getState().aiForm.wfbdzySjkZyfbStep5.form.getFieldDecorator("dayTime", {
	                            initialValue: ""
	                        })(_react2["default"].createElement(
	                            'span',
	                            null,
	                        ...
	                        _global.Global.getState().aiForm.wfbdzySjkZyfbStep5.form.getFieldDecorator("hourTime", {
	                            initialValue: ""
	                        })(_react2["default"].createElement(
	                            'span',
	                            null,
	                        ...
	                        _global.Global.getState().aiForm.wfbdzySjkZyfbStep5.form.getFieldDecorator("minTime", {
	                            initialValue: ""
	                        })(_react2["default"].createElement(
	                            'span',
	                            null,
