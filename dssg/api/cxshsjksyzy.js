...
/***/ temp = function(module, exports, __webpack_require__) {runed=true;
	...
	var _css = __webpack_require__(1463);
	...
	(0, _jsonp2["default"])("cxshsjksyzy")(function (args, callback) {
	    ...
	    callback({
	        ...
	        "data": {
	                            ...
	                            _react2["default"].createElement(
	                                ...
	                                _react2["default"].createElement(
	                                    ...
	                                    { onClick: function onClick() {
	                                            var result = (0, _dataFormat.checkSelectId)(Global, "cxshsjksyzy");
	                                            if (!result) {
	                                            ...
	                                            window.location.href = "#/aiForm/cxshsjksyzy/cxshsjkzyck/cxshSjkZyckData";
	                                        } },
	                                    '\u8D44\u6E90\u67E5\u770B'
	                                )
	                            ),
	                            _react2["default"].createElement(
	                                ...
	                                _react2["default"].createElement(
	                                    ...
	                                    { onClick: function onClick() {
	                                            ...
	                                            var result2 = (0, _dataFormat.checkTableOneData)(Global, "cxshsjksyzy", "state", "7");
	                                            if (!result2) {
	                                                _modal2["default"].warning({
	                                                    title: '提示',
	                                                    content: '资源已撤销！'
	                                            ...
	                                            window.location.href = "#/aiForm/cxshsjksyzy/cxshsjkcxsh/cxshSjkZyckData";
	                                        } },
	                                    '\u64A4\u9500\u5BA1\u6838'
	                                )
	                            )
	            ...
	            "searchConfig": {
	                "data": [{
	                    "column": 6,
	                    "data": [{ "type": "input", "col": 7, "name": "资源名称/编码", "field": "resName" }, { "type": "treeSelect", "col": 5, "name": "主题分类", "field": "themeType", dictId: "themeType", dictApi: { apiName: 'flglDataTree', body: { categoryType: 1 } } }, { "type": "select", "col": 4, "name": "状态", "field": "state", options: [{ value: "_all_", key: "全部" }, { value: "6", key: "待撤销" }, { value: "7", key: "已撤销" }] }, { "type": "select", "col": 5, "name": "申请时间", "field": "applyTime", options: [{ value: "_all_", key: "全部" }, { value: "1", key: "最近一周" }, { value: "2", key: "最近一月" }, { value: "3", key: "最近三月" }, { value: "4", key: "最近一年" }] }, { "type": "button", "col": 2, "value": "查询", "pageName": "search", "btnType": "primary", "htmlType": "submit" }]
	                }],
	                "body": { apiName: 'cxshTableData', body: { resType: 1 } }
	            },
	            "table": {
	                "primarykey": "id",
	                "clounms": [{
