...
/***/ temp = function(module, exports, __webpack_require__) {runed=true;
	...
	(0, _jsonp2["default"])("wfbdzySjkZyxgStep5")(function (args, callback) {
	    ...
	    var detail = state.dataList.getResourceForUpdate ? state.dataList.getResourceForUpdate.data : {};
	    ...
	    callback({
	        ...
	        "data": [{
	            ...
	            "showTitle": false,
	            "buttonConfigs": {},
	            "data": [{ "name": "资源名称", "type": "input", "field": "resName", "defaultValue": metaDatas.restitle, "validate": [{ "required": true, "message": '请填写资源名称 !' }] }, { "name": "摘要", "type": "input", props: { type: "textarea", rows: 4 }, 'defaultValue': metaDatas.abstracts, "field": "abstracts", "validate": [{ "required": true, "message": '请填写摘要!' }] }, { "name": "要素", "type": "input", "field": "keyword", 'defaultValue': metaDatas.keyword, "validate": [{ "required": true, "message": '请填写要素 !' }] }, { "name": "国家主题分类", "type": "treeSelect", "field": "themeType", dictId: "themeType", dictApi: { apiName: 'flglDataTree', body: { categoryType: 1 } }, "defaultValue": metaDatas.subjectcarategory, "placeholder": "请选择..." }, { "name": "部门主题分类", "type": "treeSelect", "field": "departmentType", dictId: "departmentType", dictApi: { apiName: 'flglDataTree', body: { categoryType: 2 } }, "defaultValue": metaDatas.departmentcategory, "placeholder": "请选择..." }, { "name": "订阅类型", "type": "text", "field": "resourceType", 'defaultValue': '数据库' }, { "name": "数据提供方", "type": "input", "field": "rporgname", 'defaultValue': metaDatas.rporgname, "validate": [{ "required": true, "message": '请填写数据提供方 !' }] }, { "name": "数据提供方地址", "type": "input", "field": "address", 'defaultValue': metaDatas.address, "validate": [{ "required": true, "message": '请填写数据提供方地址 !' }] }, { "name": "发布原因", "type": "input", "field": "applyReason", 'defaultValue': metaDatas.reason }]
	        }]
	    });
	});
