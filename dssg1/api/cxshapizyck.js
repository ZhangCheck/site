...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jsonp2["default"])("cxshapizyck")(function (args, callback) {
	    ...
	    var config0 = {
	        ...
	        "data": _react2["default"].createElement(_BasicMessage2["default"], { subId: 'cxshapisyzy', showValues: metadataDetail, leftShow: 'false' })
	    };
	    var config1 = [{
	        "title": "输入参数配置", //栏目标题
	        "showTitle": true, //是否展示栏目标题
	    ...
	    var config2 = [{
	        ...
	        "data": [{ "name": "撤销原因", "type": "text", mark: "fbshsyzyapi", "field": "applyReason", "defaultValue": zyfbxx.applyReason ? zyfbxx.applyReason : "" }, { "name": "申请人", "type": "text", mark: "fbshsyzyapi", "field": "applyUser", "defaultValue": zyfbxx.applyUser ? zyfbxx.applyUser : "" }],
	        "buttonConfigs": {
