...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jsonp2["default"])("wdydzywjzyck")(function (args, callback) {
	    ...
	    ysjBasicInf.resType = values.resType;
	    ysjBasicInf.pictureUrl = values.pictureUrl;
	    ysjBasicInf.updateTime = values.updateTime ? values.updateTime : "";
	    ...
	    var dysbDatas = values && values.sysEquipmentSubscribeDTO ? values.sysEquipmentSubscribeDTO : {};
	    //共享文件信息
	    var fileDatasArr = [];
	    ...
	    // 资源有效期 
	    var validateTime = [];
	    var validateBgEndTime = {
	        validBeginTime: values ? values.validBeginTime : "",
	        validEndTime: values ? values.validEndTime : ""
	    };
	    validateTime.push(validateBgEndTime);
	    var zyyxqColumns = [{
	        "title": "开始时间",
	    ...
	    callback({
	        ...
	        "data": [{
	            ...
	            "data": _react2["default"].createElement(_BasicMessage2["default"], { showValues: ysjBasicInf, subId: 'wdydzyWjZyck', leftShow: 'true' })
	        }, {
	            "title": "共享文件信息",
	            "showTitle": true,
	            "titleIcon": "catalog",
	            ...
	            "data": function data() {
	                return _react2["default"].createElement(
	                    'div',
	                    { className: "customizedTable" },
	                    _react2["default"].createElement(_table2["default"], { columns: zyyxqColumns, dataSource: validateTime, bordered: true, pagination: false })
	                );
	            }
	        }, {
	            "title": "订阅设备",
	            ...
	            "data": function data() {
	                return _react2["default"].createElement(
	                    'div',
	                    { className: "customizedTable" },
	                    _react2["default"].createElement(_table2["default"], { columns: dysbColumns, dataSource: dysbDatasArr, bordered: true, pagination: false })
	                );
	            }
	        }, {
	            "title": "资源订阅信息",
	            ...
	            "data": [{ "name": "申请订阅原因", "type": "text", "field": "fbyy", "defaultValue": resSubscribeDTO ? resSubscribeDTO.applyReason : "" }, { "name": "申请人", "type": "text", "field": "sqr", "defaultValue": resSubscribeDTO ? resSubscribeDTO.applyPerson : "" }, { "name": "申请订阅时间", "type": "text", "field": "sqr", "defaultValue": resSubscribeDTO ? resSubscribeDTO.applyTime : "" }, { "name": "审批结果", "type": "text", "field": "fbyy", "defaultValue": resSubscribeDTO ? resSubscribeDTO.stateName : "" }, { "name": "审批意见", "type": "text", "field": "fbyy", "defaultValue": resSubscribeDTO ? resSubscribeDTO.approvalOpinion : "" }, { "name": "审批时间", "type": "text", "field": "sqr", "defaultValue": resSubscribeDTO ? resSubscribeDTO.approvalTime : "" }]
	        }]
	    });
	});
