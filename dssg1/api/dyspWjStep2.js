...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jsonp2["default"])("dyspWjStep2")(function (args, callback) {
	    ...
	    var resSubscribeDetail = states.dataList.zydysplb && states.dataList.zydysplb.detailMsgDataApi && states.dataList.zydysplb.detailMsgDataApi.detailSubscribeDataApi.data ? states.dataList.zydysplb.detailMsgDataApi.detailSubscribeDataApi.data : {};
	    var fileJson = (0, _dataFormat.jsonStrToArray)(resSubscribeDetail.subDataJson ? resSubscribeDetail.subDataJson : []);
	    var rowSelection = {
	        onChange: function onChange(selectedRowKeys, selectedRows) {
	            _global.Global.mark({ aiForm: { dyspWjStep2: { dywjxxList: null } } });
	            _global.Global.mark({ aiForm: { dyspWjStep2: { dywjxxList: selectedRows } } });
	        }
	    };
	    var gxwjxxcolumns = [{
	        "title": "文件名",
	    ...
	    callback({
	        ...
	        "data": [{
	            ...
	            "titleIcon": "file-text",
	            "data": _react2["default"].createElement(_BasicMessage2["default"], { showValues: detailMsg, subId: 'zybmgl', leftShow: 'true' })
	        }, {
	            "title": "订阅文件信息",
	            "showTitle": true,
	            "childrenContentNoBorder": true,
	            "titleIcon": "copy",
	            "data": _react2["default"].createElement(_DefaultSelectTableRows2["default"], { primaryKey: 'id', id: 'dyspWjStep2SelectedTable', selectedTableColumns: gxwjxxcolumns, selectedTableData: fileJson })
