...
/***/ function(module, exports, __webpack_require__) {
	...
	var _css = __webpack_require__(1675);
	...
	(0, _jsonp2["default"])("bannerAdd")(function (args, callback) {
	    ...
	    callback({
	        ...
	        "data": [{
	            "column": 2,
	            "data": [{ "type": "input", "col": 8, "name": "标题", "field": "title", "validate": [{ "required": true, "message": '请输入标题!' }, {
	            ...
	            }, { "name": "文件", "type": "upload", "col": 8, "validate": [{ "required": true, "message": '请上传文件!' }], "field": "doc",
	                props: {
	                    ...
	                    onChange: function onChange(info) {
	                        ...
	                        if ("removed" == info.file.status) {
	                            ...
	                            for (var i = 0; i < _global.Global.getState().aiForm.fileId.length; i++) {
	                                if (info.file.response.filesId[0] == _global.Global.getState().aiForm.fileId[i]) removeIndex = i;
	                            ...
	                            for (var _i = 0; _i < _global.Global.getState().aiForm.eventList.length; _i++) {
	                                if (_i != removeIndex) eventLists.push(_global.Global.getState().aiForm.eventList[_i]);
	                            }
	                            _global.Global.mark({
	                                aiForm: {
	                                    eventList: null
