...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jsonp2["default"])("sbglConfigs")(function (args, callback) {
		callback({
			"success": true,
			"data": {
				"id": "sbglConfigs",
						...
						render: function render(text, record, index) {
							return _react2["default"].createElement(
								...
								{ style: (0, _defineProperty3["default"])({ width: _global.Global.getState().framework.columnWidth, cursor: "pointer", display: "inline-block", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", color: "#0033FF" }, 'cursor', "pointer"), onClick: function () {
										_global.Global.mark({ sbgl: { sbgl_inst: { sbxlhModal: true } } });
										_global.Global.requestApi({ apiName: 'findSysCenterEquipmentByIdInfo', body: { id: record.id } }, { sbgl: { sbgl_inst: { sbxlhModalDatas: null } } });
									}.bind(undefined) },
								text
							);
						}
	     		...
	     		return (
	     			<div>
	     				<Button type="primary" className={"dataListBtn"} onClick={function(){
	     					  Global.mark({sbgl:{sbgl_inst:{xgsbxxModal:true}}});
	     					  //设备修改还没联调
	     		...
	     		return "--"
						...
						render: function render(text, record, index) {
							if (record.type == "1") {
								...
								return _global.Global.getState().dataList.sbglConfigs.getOprationButtons([function () {
									var url = _interfaces.server + "syscenterequipment/downCerFile?publicip=" + record.publicIp;
									return _react2["default"].createElement(
										'a',
										{ href: url },
					...
					"body": { apiName: 'sbglTableData', body: { companyId: null } }
				},
				"edit": {
					"initData": {
						data: { apiName: "sbglEditDemo", title: "修改设备信息", width: 990 //增加title和width两个属性
						} },
					"dialog": {
					...
					"onUpdateSubmitApi": function onUpdateSubmitApi(values) {
						return { apiName: "sbglTableData", body: (0, _extends3["default"])({}, values, { a: 'aa' }) };
					} //接口还没给
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _css = __webpack_require__(2111);
