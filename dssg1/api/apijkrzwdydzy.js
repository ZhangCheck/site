...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jsonp2["default"])("apijkrzwdydzy")(function (args, callback) {
	    var state = _global.Global.getState();
	    var roleCode = state.framework.loginApi.data.loginUserProfileDTO.roles.code;
	    var tabData = [];
	    tabData = [{
	        show: "1",
	        urlPart: "apijkrzwfbdzy",
	        name: "我发布的资源"
	    }, {
	        show: "1",
	        urlPart: "apijkrzwdydzy",
	        name: "我订阅的资源"
	    }];
	    callback({
	        "success": true,
	        "data": {
	                    ...
	                    return _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            ...
	                            _react2["default"].createElement(
	                                ...
	                                _react2["default"].createElement(
	                                    _Download2["default"],
	                                    { body: { type: 2, ids: _global.Global.getState().dataList.apijkrzwdydzy && _global.Global.getState().dataList.apijkrzwdydzy.selectedRows ? _global.Global.getState().dataList.apijkrzwdydzy.selectedRows : [] }, method: 'POST', name: '\u670D\u52A1\u65E5\u5FD7.xls', src: _interfaces.server + "interfaceLog/exportExcelApiInterfaceLog" },
	                                    _react2["default"].createElement(
	                                        'a',
	                                        null,
	                                        '\u5BFC\u51FA'
	            ...
	            "searchConfig": {
	                "data": [{
	                    ...
	                    "data": [{ "type": "input", "col": 5, "name": "API接口服务", "field": "serviceName" }, { "name": "时间范围", "col": 10, "labelCol": 6, "wrapperCol": 18, "field": "timeList", "type": "rangePicker", "defaultValue": "" }, { "type": "select", "col": 5, "name": "操作结果",
	                        defaultValue: "_all_",
	                        'options': [{ key: '全部', value: '_all_' }, { key: '成功', value: '0' }, { key: '失败', value: '1' }], "field": "state" }, {
	                        "type": "button",
	                        "col": 2,
	                        "value": "查询",
	                        "pageName": "search",
	                ...
	                "body": { apiName: 'findApiInterfaceLogSubscribe' }
	            },
	            "table": {
	                "primarykey": "id",
	                "clounms": [{
	                    ...
	                    "render": function render(text, recode, index) {
	                        var state = _global.Global.getState().dataList.apijkrzwdydzy;
	                        return _react2["default"].createElement(
	                            'div',
	                            null,
	                    ...
	                    "title": "发布设备",
	                    "dataIndex": "publishEquipment",
	                    "key": "publishEquipment"
	                },
	                /* {
	                     "title":"发布方用户",
	                 ...
	                 },*/
	                {
	                    ...
	                    "render": function render(text, record, index) {
	                        return _react2["default"].createElement(
	                            'div',
	                            { style: { color: "#1f94e4", cursor: 'pointer' }, onClick: function onClick() {
	                                    //Global.mark({dataList:{apijkrzwdydzy:{selectedRows:[record.id]}}});
	                                    _global.Global.dispatch((0, _dataList.showDetailDlg)('apijkrzwdydzy', record.id));
	                                } },
	                            "详情"
	                        );
	                    }
	            ...
	            "detail": {
	                "initData": {
	                    data: { apiName: "apijkrzwdydzyDetail" }
	                },
	                "body": { apiName: 'findApiInterfaceLogById' }
	            },
	            "check": {
	                "view": null,
	                "checkApi": null
