...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jsonp2["default"])("dyspWjDyspStep1")(function (args, callback) {
	    ...
	    ysjBasicInf.resType = apiData.resType ? apiData.resType : "";
	    ysjBasicInf.updateTime = apiData.updateTime ? apiData.updateTime : "";
	    ysjBasicInf.pictureUrl = apiData.pictureUrl ? apiData.pictureUrl : "";
	    ...
	    var subscriber = [];
	    if (apiData.sysEquipmentSubscribeDTO) {
	        subscriber.push(apiData.sysEquipmentSubscribeDTO);
	    }
	    //订阅用户
	    var dyyhCloumn = [{
	        "title": "订阅单位",
	    ...
	    callback({
	        ...
	        "data": [{
	            ...
	            "data": [{ "name": "申请订阅原因", "type": "text", "field": "applyReason", "defaultValue": resSubscribeDTO.applyReason }, { "name": "申请设备", "type": "text", "field": "applyUser", "defaultValue": resSubscribeDTO.applyPerson }, { "name": "申请订阅时间", "type": "text", "field": "applyTime", "defaultValue": resSubscribeDTO.applyTime }, { "name": "", "type": "text", "field": "id", props: { style: { display: "none" } }, "defaultValue": apiData.id ? apiData.id : "" }]
	        }, {
	            "title": "资源订阅审批信息",
	            "column": 2,
	            "showTitle": true,
	            "titleIcon": "res-pub-mes",
	            "data": [{ "type": "select", "name": "审批结果", "field": "result", "defaultValue": "0", "options": [{ "value": "0", "key": "通过" }, { "value": "-1", "key": "拒绝" }] }, { "name": "审批意见", "type": "input", props: { type: "textarea", rows: 4 }, "field": "reviewDesc" }]
	        }]
	    });
	});
