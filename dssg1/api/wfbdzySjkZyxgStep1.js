	    ...
	    callback({
	        ...
	        "data": {
	            ...
	            "searchConfig": {
	                "data": [{
	                    "column": 4,
	                    "data": [{ "type": "input", "name": "目录名称/编码", "field": "resName" }, { "type": "treeSelect", "name": "国家主题分类", "field": "themeType", dictId: "themeType", dictApi: { apiName: 'flglData' } }, { "type": "treeSelect", "name": "部门主题分类", "field": "departmentType", dictId: "departmentType", dictApi: { apiName: 'flglData' } }, { "type": "button", "value": "查询", "pageName": "search", "btnType": "primary", "htmlType": "submit" }]
	                }],
