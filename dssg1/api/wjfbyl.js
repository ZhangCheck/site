...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jsonp2["default"])("wjfbyl")(function (args, callback) {
	    ...
	    callback({
	        ...
	        "data": [{
	            ...
	            "showTitle": true, //是否展示栏目标题
	            "data": function data() {
	                return _react2["default"].createElement(Table, { columns: gxmlcolumns, dataSource: "" });
	            }
	        }, {
	            "title": "共享目录数据项", //栏目标题
	            "column": 2, //  form显示列数，首先读取每个标签的设置column值，不存在才会读取总的column,如果不存在，默认展示一列
	            ...
	            "showTitle": true, //是否展示栏目标题
	            "data": function data() {
	                return _react2["default"].createElement(Table, { columns: gxmlsjxcolumns, dataSource: "" });
	            }
	        }, {
	            "title": "更新策略", //栏目标题
	            "column": 2, //  form显示列数，首先读取每个标签的设置column值，不存在才会读取总的column,如果不存在，默认展示一列
	            ...
	            "data": function data() {
	                return _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(Table, { columns: gxclcolumns, dataSource: "" })
	                );
	            }
	        }, {
	            "title": "资源申请发布信息", //栏目标题
