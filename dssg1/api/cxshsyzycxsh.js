...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jsonp2["default"])("cxshsyzycxsh")(function (args, callback) {
	    ...
	    callback({
	        ...
	        "data": [{
	            ...
	            "wrapperCol": 16, //form显示框宽度
	            "showTitle": true, //是否展示栏目标题
	            "data": [{ "name": "撤销原因", "type": "text", "field": "fbyy", "defaultValue": "内容是未知的" }, { "name": "申请人", "type": "text", "field": "sqr", "defaultValue": "内容是未知的" }, { "name": "申请时间", "type": "text", "field": "sqsj", "defaultValue": "内容是未知的" }, { "name": "生效时间", "type": "text", "field": "sxsj", "defaultValue": "内容是未知的" }]
	        }, {
	            "title": "资源撤销审核信息", //栏目标题
	            "column": 2, //  form显示列数，首先读取每个标签的设置column值，不存在才会读取总的column,如果不存在，默认展示一列
	            "labelCol": 8, // form标头name宽度
	            ...
	            "showTitle": true, //是否展示栏目标题
	            "buttonConfigs": {
	                "buttons": [{ "type": "button", "value": "取消", props: { "style": { "float": "right" } } }, { "type": "button", "value": "确定", props: { type: "primary", "style": { "float": "right" } } }]
	            },
