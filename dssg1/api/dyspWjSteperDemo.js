...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jsonp2["default"])("dyspWjSteperDemo")(function (args, callback) {
	    ...
	    callback({
	        ...
	        "data": {
	            ...
	            "steps": [{
	                ...
	                "type": "aiForm",
	                "configStepApi": "dyspWjStep2",
	                "number": "2",
	                "name": "查看元数据信息",
	                "id": "dyspWjStep2",
	                "validate": function validate() {
	                    var selected = _global.Global.getState().defaultSelectTableRows.dyspWjStep2SelectedTable.keys;
	                ...
	                "type": "aiForm",
	                "configStepApi": "dyspWjStep3",
	                "number": "3",
	                "name": "填写审批意见",
	                "id": "dyspWjStep3",
	                "validate": function validate() {

	                    var form = states.aiForm.dyspWjStep3.form;
	                    ...
	                    if (validate) {
	                        var apiConfig = (0, _extends3["default"])({}, _interfaces.dyspSubmit, {
	                            body: (0, _extends3["default"])({}, _interfaces.dyspSubmit.body, _global.Global.getState().aiForm.dyspWjStep3.values, values) });
	                        return apiConfig;
	                    }
	                }
	            }]
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _css2 = __webpack_require__(1862);
	...
	var _Rect = __webpack_require__(1882);
