...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jsonp2["default"])("dyspSjkStep2")(function (args, callback) {
	    ...
	    var detailMsgSubscribe = states.dataList.zydysplb && states.dataList.zydysplb.detailMsgDataApi && states.dataList.zydysplb.detailMsgDataApi.detailSubscribeDataApi && states.dataList.zydysplb.detailMsgDataApi.detailSubscribeDataApi.data ? states.dataList.zydysplb.detailMsgDataApi.detailSubscribeDataApi.data : {};
	    var dbJson = (0, _dataFormat.jsonStrToArray)(detailMsgSubscribe.subDataJson);
	    ...
	    var config = [{
	        ...
	        "titleIcon": "file-text",
	        "data": _react2["default"].createElement(_BasicMessage2["default"], { showValues: detailMsg, subId: 'zydysplb', leftShow: 'true' })
	    }];
	    var dbJsonColumns = [{
	        "title": '数据项名称',
	        "dataIndex": 'name',
	    ...
	    config[1] = {
	        ...
	        "data": function data() {
	            return _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(_table2["default"], { bordered: true, columns: dbJsonColumns, dataSource: dbJson, key: 'sjxyl', pagination: false, rowSelection: {
	                        selectedRowKeys: _global.Global.getState().aiForm.dyspSjkStep2 && _global.Global.getState().aiForm.dyspSjkStep2.selectedDbJson1 ? _global.Global.getState().aiForm.dyspSjkStep2.selectedDbJson1 : [],
	                        onChange: function (selectedRowKeys, selectedRows) {
	                            _global.Global.mark({ aiForm: { dyspSjkStep2: { selectedDbJson1: selectedRowKeys } } });
	                            _global.Global.mark({ aiForm: { dyspSjkStep2: { selectedDbJson: selectedRows } } });
	                        }.bind(undefined)
