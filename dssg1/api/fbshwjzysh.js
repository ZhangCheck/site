	...
	(0, _jsonp2["default"])("fbshwjzysh")(function (args, callback) {
	    ...
	    callback({
	        ...
	        "data": [{
	            ...
	            "data": _react2["default"].createElement(_BasicMessage2["default"], { subId: 'fbshWjZysh', showValues: ysjBasicInf, leftShow: 'false' })
	        }, {
	            "title": "共享文件信息",
	            "showTitle": true,
	            "titleIcon": "catalog",
	            ...
	            "data": [{ "name": "审批结果", "type": "select", "field": "result", defaultValue: "0", "options": [{ value: "0", key: "通过" }, { value: "-1", key: "拒绝" }] }, { "name": "审核意见", "type": "input", props: { type: "textarea", rows: 4 }, "field": "reviewDesc", "defaultValue": "" }]
	        }]
	    });
	});
