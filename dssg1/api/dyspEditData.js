...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jsonp2["default"])("dyspEditData")(function (args, callback) {
	    var states = _global.Global.getState();
	    var target = args.target;
	    var values = states.aiForm.dyspEditData && states.aiForm.dyspEditData.values ? states.aiForm.dyspEditData.values : "";
	    var allMsgData = states.dataList.getDyspEdit.detailMsgDataApi[0];

	    if (allMsgData == null) {
	        _modal2["default"].warning({
	            title: '提示',
	            content: '查询数据失败，请重新选择资源进行审批',
	            onOk: function onOk() {
	                /* */
	                setTimeout(function () {
	                    ...
	                    _history2["default"].push('/datalistV1/dysp/list/11/9');
	                }, 500);
	            }
	        });
	        return;
	    }
	    if (!_global.Global.getState().dataList.getDyspEdit) {
	        _modal2["default"].warning({
	            title: '提示',
	            content: '页面刷新，请重新选择资源进行审批',
	            onOk: function onOk() {
	                /* */
	                setTimeout(function () {
	                    _global.Global.mark({ dataList: {
	    ...
	    var metadataDetail = allMsgData.metadataDTO ? allMsgData.metadataDTO : values;
	    metadataDetail.resType = allMsgData.resType;
	    metadataDetail.pictureUrl = allMsgData.pictureUrl;
	    metadataDetail.updateTime = allMsgData.updateTime ? allMsgData.updateTime : "1991-12-12 12:45:45";
	    var subscriber = [];
	    subscriber.push(allMsgData && allMsgData.sysEquipmentSubscribeDTO ? allMsgData.sysEquipmentSubscribeDTO : "");
	    var subContent = allMsgData.resSubscribeDTO && allMsgData.resSubscribeDTO.subDataJson ? (0, _dataFormat.jsonStrToArray)(allMsgData.resSubscribeDTO.subDataJson) : [];
	    var zydyxx = allMsgData.resSubscribeDTO ? allMsgData.resSubscribeDTO : {};
	    //共享目录数据项
	    var gxmlsjxCloumn = [{
	        title: "数据项名称",
	        dataIndex: 'name',
	    ...
	    callback({
	        ...
	        "data": [{
	            ...
	            "showTitle": true,
	            "titleIcon": "file-text",
	            "data": [{ "type": "text", "name": "申请订阅原因", "field": "applyReason", "defaultValue": zydyxx.applyReason ? zydyxx.applyReason : "" }, { "type": "text", "name": "申请设备", "field": "applyPerson", "defaultValue": zydyxx.applyPerson ? zydyxx.applyPerson : "" }, { "type": "text", "name": "申请订阅时间", "field": "applyTime", "defaultValue": zydyxx.applyTime ? zydyxx.applyTime : "" }]
	        }, {
	            "title": "资源订阅审批信息",
	            "column": 1,
	            //便于赋值，编号
	            "showTitle": true,
	            "titleIcon": "file-text",
	            "data": [{ "type": "select", "name": "审批结果", "field": "result", "defaultValue": values.result ? values.result : "0", "validate": [{ "required": true }], "options": [{ "value": "0", "key": "通过" }, { "value": "-1", "key": "拒绝" }] }, { "type": "input", "inputType": "textarea", "name": "审批意见", "defaultValue": values.approvalOpinion ? values.approvalOpinion : "", "field": "approvalOpinion", props: { rows: 4 } }]
	        }]
	    });
	});
