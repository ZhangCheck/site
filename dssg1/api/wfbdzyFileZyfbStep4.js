	        ...
	        "data": [{
	            ...
	            "data": [{ "name": "调度模式", "type": "select", "field": "ddModel", "defaultValue": 1, "placeholder": "请选择...", "options": [{ value: 1, key: "周期模式" }, { value: 2, key: "定期模式" }, { value: 3, key: "触发器模式" }] }, { "name": "开始时间", "field": "startTime", "type": "datePicker", "defaultValue": "",
	                preRender: function preRender() {
	                    return _global.Global.getState().aiForm.wfbdzyFileZyfbStep4.form.getFieldValue('ddModel') == 2 || _global.Global.getState().aiForm.wfbdzyFileZyfbStep4.form.getFieldValue('ddModel') == 3 ? "hidden" : "";
	                }
	            }, { preRender: function preRender() {
	                    return _global.Global.getState().aiForm.wfbdzyFileZyfbStep4.form.getFieldValue('ddModel') == 2 || _global.Global.getState().aiForm.wfbdzyFileZyfbStep4.form.getFieldValue('ddModel') == 3 ? "hidden" : "";
	                },
	                "value": function value(config) {
	                    ...
	                    return _global.Global.getState().aiForm.wfbdzyFileZyfbStep4.form.getFieldValue('ddModel') == 1 || _global.Global.getState().aiForm.wfbdzyFileZyfbStep4.form.getFieldValue('ddModel') == 3 ? "hidden" : "";
	                },
	                "value": _react2["default"].createElement(_Timer2["default"], { id: 'wfbdzyFileZyfbStep4' })
	            }]
	        }, {
	            "title": "文件共享等级配置",
	            "column": 1,
	            ...
	            "labelCol": 12,
	            "wrapperCol": 12,
	            "data": [{ "name": "文件等级", "type": "select", "field": "fileLevel", "defaultValue": 1, "placeholder": "请选择...", "options": [{ "value": 1, "key": "一级" }, { "value": 2, "key": "二级" }, { "value": 3, "key": "三级" }] }]
	        }]
	    };
