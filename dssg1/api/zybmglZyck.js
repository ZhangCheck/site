...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jsonp2["default"])("zybmglZyck")(function (args, callback) {
	    var states = _global.Global.getState();
	    var target = args.target;
	    var detailValue = states.pageLoader && states.pageLoader.zybmckBlank && states.pageLoader.zybmckBlank.detail.data ? states.pageLoader.zybmckBlank.detail.data : {};

	    var metadataDetail = {};
	    metadataDetail.resCode = detailValue.resCode ? detailValue.resCode : "";
	    metadataDetail.resEname = detailValue.resEname ? detailValue.resEname : "";
	    metadataDetail.resName = detailValue.resName ? detailValue.resName : "";
	    metadataDetail.abstracts = detailValue.abstracts ? detailValue.abstracts : "";
	    metadataDetail.resType = detailValue.resType ? detailValue.resType : "";
	    metadataDetail.resLevel = detailValue.resLevel ? detailValue.resLevel : "";
	    metadataDetail.catalogName = detailValue.catalogName ? detailValue.catalogName : "";
	    metadataDetail.updateCycle = detailValue.updateCycle ? detailValue.updateCycle : "";
	    metadataDetail.themeName = detailValue.themeTypeName ? detailValue.themeTypeName : "";
	    metadataDetail.filePath = detailValue.filePath && detailValue.filePath != "" ? detailValue.filePath : detailValue.pictureUrl ? detailValue.pictureUrl : "";
	    metadataDetail.industryTypeName = detailValue.industryTypeName ? detailValue.industryTypeName : "";
	    var config = [{
	        "title": "元数据基本信息",
	        "column": 1,
	        "showTitle": false,
	    ...
	    if (detailValue.resType == "1") {
	        var sjkValuesStep3 = detailValue.dbJson && detailValue.dbJson != null && detailValue.dbJson != "" ? (0, _dataFormat.jsonStrToArray)(detailValue.dbJson) : [];
	        ...
	        config[1] = {
	            ...
	            "childrenContentFormItemHeightLow": true,
	            "buttonConfigs": {
	                "buttons": [{ "type": "button", "value": "关闭", "field": "back", props: { btnType: "primary", "style": { "float": "right" } } }]
	            },
	            "data": function data() {
	                return _react2["default"].createElement(
	                    'div',
	                    { className: "customizedTable2" },
	                    _react2["default"].createElement(_table2["default"], { columns: zybmglCloumns, dataSource: sjkValuesStep3, key: 'zybmglAdd', bordered: true, pagination: false })
	                );
	            }

	        };
	    } else if (detailValue.resType == "2") {
	        config[0].buttonConfigs = {
	            "buttons": [{ "type": "button", "value": "关闭", "field": "back", props: { btnType: "primary", "style": { "float": "right" } } }]
	        };
	    } else if (detailValue.resType == "3") {
	        var columns = [{
	            "title": '参数名称',
	            "dataIndex": 'name'
	        }, {
	        ...
	        var aFTDStep3 = apiJson.length > 0 ? apiJson[0].requestParams : [];
	        ...
	        config[2] = {
	            ...
	            "data": function data() {
	                return _react2["default"].createElement(
	                    'div',
	                    { className: "customizedTable2" },
	                    _react2["default"].createElement(_table2["default"], { columns: columns1, dataSource: aFTDStep4, bordered: true, key: 'zybmglRes', pagination: false })
	                );
	            }
