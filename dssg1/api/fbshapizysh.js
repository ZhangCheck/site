...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jsonp2["default"])("fbshapizysh")(function (args, callback) {
	    ...
	    metadataDetail.resType = msgDatas.resType;
	    ...
	    var pzzyyxq = [];
	    pzzyyxq.push({ resRender: "资源有效期", validBeginTime: msgDatas.validBeginTime, validEndTime: msgDatas.validEndTime });
	    var sccscolumns = [{
	        "title": "参数名称",
	        "dataIndex": "name",
	        "key": "name"
	    ...
	    var config2 = [{
	        ...
	        "showTitle": true, //是否展示栏目标题
	        "buttonConfigs": {
	            "onSubmitApi": { apiName: "fbshSyzySubmit1", body: (0, _extends3["default"])({}, values) },
	            "getValue": { id: "aFBCD", index: showTitle == true ? 7 : 5 },
