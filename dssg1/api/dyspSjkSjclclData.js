...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jsonp2["default"])("dyspSjkSjclclData")(function (args, callback) {
	    ...
	    var sjtcCloumn = [{
	        ...
	        title: "字段名称",
	        dataIndex: 'columnName4',
	        key: 'columnName3',
	        "render": { "type": "select", props: { style: { width: 150 } }, "options": options }
	    }, {
	        title: "中文名称",
	        dataIndex: 'columnEnName4',
	        key: 'columnEnName3',
	        "render": { "type": "input", props: { style: { width: 200 } } }
	    }, {
	        title: "展示规则",
	        ...
	        "data": [{
	            ...
	            "data": _react2["default"].createElement(_AiFormTable2["default"], { config: {
	                    ...
	                    "addTemplate": { //表格初始化新增行数据
	                        "resourceName1": "",
	                        "columnName1": options.length > 0 ? options[0] : "",
	                        "columnEnName1": "",
	                        "operators1": ">",
	                        "value1": ""
	                    }
	            ...
	            "data": _react2["default"].createElement(_AiFormTable2["default"], { config: {
	                    ...
	                    "addTemplate": { //表格初始化新增行数据
	                        "resourceName2": "",
	                        "columnName2": options.length > 0 ? options[0] : "",
	                        "columnEnName2": "",
	                        "content2": "",
	                        "value2": ""
	                    }
	            ...
	            "data": _react2["default"].createElement(_AiFormTable2["default"], { config: {
	                    ...
	                    "addTemplate": { //表格初始化新增行数据
	                        "resourceName3": "",
	                        "columnName3": options.length > 0 ? options[0] : "",
	                        "columnEnName3": "",
	                        "ruleCode3": ""
	                    }
