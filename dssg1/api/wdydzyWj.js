	    ...
	    callback({
	        ...
	        "data": {
	            ...
	            "searchConfig": {
	                "data": [{
	                    "column": 6,
	                    "data": [{ "type": "input", "col": 7, "name": "资源名称/编码", "field": "resName" }, { "type": "treeSelect", "col": 6, "name": "国家主题分类", "field": "themeType", options: { value: "_all_", key: "全部" }, dictId: "themeType", dictApi: { apiName: 'getDictsByType', body: { name: "themeType", type: 1 } } }, { "type": "select", "col": 4, "name": "状态", "field": "state",
	                        "options": [{ value: "_all_", key: "全部" }, { value: "0", key: "待审核" }, { value: "1", key: "已订阅" }, { value: "2", key: "已拒绝" }, { value: "8", key: "已取消" }, { value: "7", key: "已过期" }, { value: "5", key: "已撤销" }]
	            ...
	            "table": {
	                ...
	                "clounms": [{
	                    ...
	                    "key": "resName",
	                    "width": 200,
	                    "render": _tableLayout.column1Render
	                }, {
	                    "title": "资源编码",
	                    "dataIndex": "resCode",
	                    "key": "resCode",
	                    "width": 600,
	                    "render": _tableLayout.column2Render
	                }, {
	                    "title": "申请单位",
	                    "dataIndex": "applyUser",
	                    "key": "applyUser",
	                    "render": _tableLayout.column2To3Render
	                }, {
	                    "title": "资源等级",
	                    "dataIndex": "resLevelName",
	                    "key": "resLevelName",
	                    "render": _tableLayout.column3Render
	                }, {
	                    "title": "国家主题分类",
	                    "dataIndex": "themeName",
	                    "key": "themeName",
	                    "render": _tableLayout.column4Render
	                }],
	                "body": { apiName: 'wdydzyWjTableData' }
	            }
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _css2 = __webpack_require__(2270);
