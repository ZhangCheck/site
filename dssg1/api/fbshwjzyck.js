...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jsonp2["default"])("fbshwjzyck")(function (args, callback) {
	    ...
	    var zyyxq = [];
	    var validBeginTime = state.dataList.fbshsyzywj.detailMsgDataApi.data.validBeginTime;
	    var validEndTime = state.dataList.fbshsyzywj.detailMsgDataApi.data.validEndTime;
	    zyyxq.push({
	        "zyyxq": "",
	    ...
	    } else if (dispatchStrategy.dispatchType == 1) {
	    ...
	    callback({
	        ...
	        "data": [{
	            ...
	            "data": _react2["default"].createElement(_BasicMessage2["default"], { subId: 'fbshWjZyck', showValues: ysjBasicInf, leftShow: 'false' })
	            ...
	            "data": function data() {
	                return _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(_table2["default"], { columns: dispatchStrategy.dispatchType == 1 ? gxclCloumn_zq : dispatchStrategy.dispatchType == 1 ? gxclCloumn_dq : gxclCloumn_cfq, dataSource: ddModelDatas, bordered: true, pagination: false })
	                );
	            }
	        }, {
	            "title": "资源有效期",
