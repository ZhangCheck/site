...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jsonp2["default"])("metadataEdit1")(function (args, callback) {
	    ...
	    callback({
	        ...
	        "data": [{
	            ...
	            "data": [{ "type": "input", "name": "数据元名称", "field": "name", defaultValue: detailValue.name, "placeholder": "汉字、数字、字母或下划线", "validate": [{
	                ...
	                }] }, { "type": "treeSelect", "name": "数据元分类", "field": "classify", "dictId": "classify", defaultValue: detailValue.classify ? detailValue.classify : "",
	                dictApi: { apiName: 'getDictsByType', body: { type: 3, name: "classify" } },
	                "validate": [{ "required": true, "message": '不能为空!' }]
	            }, { "type": "select", "name": "数据类型", "field": "dataType", props: { disabled: true }, defaultValue: detailValue.dataType, options: [{ value: "12", key: "文本" }, { value: "3", key: "数字" }, { value: "91", key: "日期" }, { value: "93", key: "时间" }, { value: "4", key: "整型" }], "validate": [{
	                    "required": true, "message": '不能为空!'
	                ...
	                }] }, { "type": "select", "name": "是否字典项", "field": "isDictionary", props: { disabled: true }, defaultValue: detailValue.isDictionary ? detailValue.isDictionary : "1", "options": [{ "value": "0", "key": "是" }, { "value": "1", "key": "否" }] }, { "type": "select", "name": "用户字典", "field": "dictionaryId", defaultValue: detailValue.dictionaryId ? detailValue.dictionaryId : "",
	                "dictId": "dictionaryId",
