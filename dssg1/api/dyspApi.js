	    ...
	    callback({
	        ...
	        "data": {
	            ...
	            "searchConfig": {
	                "data": [{
	                    "column": 4,
	                    "data": [{ "type": "input", "col": 7, "name": "资源名称/编码", "field": "resName" }, { "type": "treeSelect", "col": 6, "name": "国家主题分类", "field": "themeType", dictId: "themeType", dictApi: { apiName: 'flglData' } }, { "type": "select", "col": 4, "name": "状态", "field": "state", dictId: "state" }, { "type": "select", "col": 5, "name": "发布时间", "field": "approvalTime", dictId: "fbsj" }, { "type": "button", "col": 1, "value": "查询", "pageName": "search", "btnType": "primary", "htmlType": "submit" }]
	                }],
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _css = __webpack_require__(1760);
