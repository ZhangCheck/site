...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jsonp2["default"])("fbshsjkzysh")(function (args, callback) {
	    ...
	    var detailMsg = state.dataList.fbshsyzysjk.detailMsgDataApi && state.dataList.fbshsyzysjk.detailMsgDataApi.data ? state.dataList.fbshsyzysjk.detailMsgDataApi.data : {};
	    ...
	    //更新策略
	    var gxcl = (0, _dataFormat.jsonStrToArray)(detailMsg.dispatchStrategyJson) ? (0, _dataFormat.jsonStrToArray)(detailMsg.dispatchStrategyJson) : [];
	    ...
	    var gxmuxx = [{
	        ...
	        "resType": detailMsg.resType,
	        "themType": detailMsg.themeTypeName,
	        "departmentType": detailMsg.departmentTypeName,
	        "resClassDirName": detailMsg.resClassDirName,
	        "resLevel": detailMsg.resLevel
	    }];
	    ...
	    var values = {};
	    values = (0, _extends3["default"])({}, values, { type: "0", resourceId: detailMsg.id, resType: detailMsg.resType });
	    callback({
	        "success": true,
	        "data": [{
	            "title": "元数据基本信息", //栏目标题
