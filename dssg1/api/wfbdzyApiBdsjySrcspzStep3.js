...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jsonp2["default"])("wfbdzyApiBdsjySrcspzStep3")(function (args, callback) {
	    ...
	    var srcspz = [];
	    //let dataSource = [{name:"aaa",type:"系统参数"},{name:"bbb",type:"系统参数"}];
	    var dataSource = (0, _dataFormat.jsonStrToArray)(states.dataList.fbzyList.detailMsgDataApi.data.apiJson)[0].requestParams;
	    ...
	    var columns = [{
	        ...
	        "key": 'conditionExp',
	        "render": { "type": "select", "labelCol": 0, "wrapperCol": 24, options: ["like", "=", ">", ">=", "<", "<=", "!="], props: { style: { width: "100%" } } }
	    }, {
	        "title": '是否必填',
	        "dataIndex": 'mandatory',
	        "key": 'mandatory',
	    ...
	    callback({
	        ...
	        "data": [{
	            "data": _react2["default"].createElement(_AiFormTable2["default"], { config: {
	                ...
	                }, id: 'aFTDStep3', form: target.props.form })
