...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jsonp2["default"])("apijkrzwfbdzy")(function (args, callback) {
	    ...
	    callback({
	        ...
	        "data": {
	                    ...
	                    return _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            ...
	                            _react2["default"].createElement(
	                                ...
	                                _react2["default"].createElement(
	                                    _Download2["default"],
	                                    { body: { type: 1, ids: _global.Global.getState().dataList.apijkrzwfbdzy && _global.Global.getState().dataList.apijkrzwfbdzy.selectedRows ? _global.Global.getState().dataList.apijkrzwfbdzy.selectedRows : [] }, name: '\u670D\u52A1\u65E5\u5FD7.xls', method: 'POST', src: _interfaces.server + "interfaceLog/exportExcelApiInterfaceLog" },
	                                    _react2["default"].createElement(
	                                        'a',
	                                        null,
	                                        '\u5BFC\u51FA'
	            ...
	            "searchConfig": {
	                ...
	                "body": { apiName: 'findApiInterfaceLogPublish' }
	            },
	            "table": {
	                "primarykey": "id",
	                "clounms": [{
	                    ...
	                    "render": function render(text, recode, index) {
	                        var state = _global.Global.getState().dataList.apijkrzwfbdzy;
	                        return _react2["default"].createElement(
	                            'div',
	                            null,
	                    ...
	                    "render": function render(text, record, index) {
	                        return _react2["default"].createElement(
	                            ...
	                            { style: { color: "#1f94e4", cursor: 'pointer' }, onClick: function onClick() {
	                                    ...
	                                    _global.Global.dispatch((0, _dataList.showDetailDlg)('apijkrzwfbdzy', record.id));
	                                } },
	                            "详情"
	                        );
	                    }
	            ...
	            "detail": {
	                "initData": {
	                    data: { apiName: "apijkrzwfbdzyDetail" }
	                },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _css = __webpack_require__(1661);
