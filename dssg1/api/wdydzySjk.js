	      ...
	      "searchConfig": {
	        "data": [{
	          ...
	          "data": [{ "type": "input", "col": 7, "name": "资源名称/编码", "field": "resName" }, {
	            ...
	            "options": [{ value: "_all_", key: "全部" }, { value: "0", key: "待审核" }, { value: "1", key: "已订阅" }, {
	              value: "2",
	              key: "已拒绝"
	            }, { value: "8", key: "已取消" }, { value: "7", key: "已过期" }, { value: "5", key: "已撤销" }]
	          }, {
	            "type": "select",
	            "col": 5,
	            "name": "订阅时间",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _css = __webpack_require__(2237);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _css2 = __webpack_require__(2237);
