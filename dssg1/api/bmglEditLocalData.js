...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jsonp2["default"])("bmglEditLocalData")(function (args, callback) {
	    var target = args.target;
	    var values = _global.Global.getState().dataList.bmglLocal.detailMsgDataApi && _global.Global.getState().dataList.bmglLocal.detailMsgDataApi.data ? _global.Global.getState().dataList.bmglLocal.detailMsgDataApi.data : {};
	    var detailValue = [];
	    if (args.type == "add") {
	    ...
	    callback({
	        ...
	        "data": [{
	            ...
	            "showTitle": true,
	            "buttonConfigs": {
	                "buttons": [{ "type": "button", "value": "返回", mark: "bmglLocal", "field": "back", props: { btnType: "primary", "style": { "float": "right" } } }, { "type": "button", "value": "确定", mark: "bmglLocal", "field": "submit", props: { "style": { "float": "right" }, htmlType: "submit" } }]
	            },
