...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jsonp2["default"])("dwglLocalList")(function (args, callback) {
	    ...
	    callback({
	        ...
	        "data": {
	            ...
	            { "buttonName": "direction", "act": "upgrade", "icon": "arrow-left", "value": "升级" }, { "buttonName": "direction", "act": "downgrade", "icon": "arrow-right", "value": "降级" }],
	            "searchConfig": {
	                "data": [{
	                    "column": 4,
	            ...
	            "add": {
	                "initData": {
	                    data: { apiName: "getDwglLocalEdit" }
	                },
	                "onAddSubmitApi": { "apiName": "dwglAddLocalInfo" }
	            },
	            "edit": {
	                "initData": {
	                    data: { apiName: "getDwglLocalEdit" }
	                },
	                "onUpdateSubmitApi": { "apiName": "dwglEditLocalInfo" }
	            },
	            "delete": {
	                "body": { apiName: 'deletedwglLocalInfo' }
	            },
	            "detail": {
	                "body": { apiName: 'dwglLocalDetail' }
	            },
	            "check": {
	                "view": null,
	                "checkApi": null
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _css = __webpack_require__(1743);
