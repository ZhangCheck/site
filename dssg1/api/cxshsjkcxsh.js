...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jsonp2["default"])("cxshsjkcxsh")(function (args, callback) {
	    ...
	    var detailMsg = state.dataList.cxshsjksyzy && state.dataList.cxshsjksyzy.detailMsgDataApi && state.dataList.cxshsjksyzy.detailMsgDataApi.data ? state.dataList.cxshsjksyzy.detailMsgDataApi.data : {};
	    ...
	    // let gxmuxx = getTableData(detailMsg);
	    var resourceTimes = [];
	    resourceTimes.push({
	        "dispatchType": '资源有效期',
	    ...
	    var zydyxx = detailMsg && detailMsg.processRecordRevocationDTO != null ? detailMsg.processRecordRevocationDTO : {};
	    var gxclDdpz = [];
	    ...
	    var values = {};
	    values = (0, _extends3["default"])({}, values, { type: "-1", resourceId: detailMsg.id, resType: detailMsg.resType });
	    callback({
	        "success": true,
	        "data": [{
	            "title": "元数据基本信息", //栏目标题
