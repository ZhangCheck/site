...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jsonp2["default"])("cxshsjkzyck")(function (args, callback) {
	    ...
	    var zycxxx = args.detail.processRecordRevocationDTO ? args.detail.processRecordRevocationDTO : {};
	    //更新策略
	    ...
	    resourceTimes.push({
	        "dispatchType": '资源有效期',
	        "startTime": _global.Global.getState().dataList.cxshsjksyzy.detailMsgDataApi.data.validBeginTime,
	        "endTime": _global.Global.getState().dataList.cxshsjksyzy.detailMsgDataApi.data.validEndTime
	    });
	    var gxmuxx = [{
	    ...
	    callback({
	        ...
	        "data": [{
	            ...
	            "data": _react2["default"].createElement(_BasicMessage2["default"], { subId: 'cxshsjksyzy', showValues: metadataDetail, leftShow: 'false' })
	        }, {
	            "title": "共享目录信息", //栏目标题
	            "titleIcon": "catalog",
	            "showTitle": true, //是否展示栏目标题
	            ...
	            "data": [{ "name": "撤销原因", "type": "text", "field": "revokeReason", "defaultValue": zycxxx.applyReason ? zycxxx.applyReason : "" }, { "name": "申请人", "type": "text", "field": "applyUser", "defaultValue": zycxxx.applyUser ? zycxxx.applyUser : "" }, { "name": "申请时间", "type": "text", "field": "applyTime", "defaultValue": zycxxx.applyTime ? zycxxx.applyTime : "" }, { "name": "生效时间", "type": "text", "field": "sxsj", "defaultValue": zycxxx.effectiveData ? zycxxx.effectiveData : "" }]
	        }]
	    });
	});
