...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jsonp2["default"])("wgldmlEditLocalData")(function (args, callback) {
	    ...
	    var detailValue = states.dataList.wgldmlLocal.detailMsgDataApi ? states.dataList.wgldmlLocal.detailMsgDataApi.data : {};
	    if (args.type) {
	        detailValue = {};
	    }
	    ...
	    var metadataCloumns = [{
	        ...
	        "dataIndex": "operation",
	        "key": "operation",
	        "render": [{ "type": "up", "icon": "arrow-up", props: { style: { fontSize: 14, color: "#21b597" } } }, { "type": "down", "icon": "arrow-down", props: { style: { fontSize: 14, color: "#21b597" } } }, { "type": "delete", "icon": "close-square", props: { style: { fontSize: 14, color: "#21b597" } } }, { "type": function type(that, index) {
	                return _react2["default"].createElement(_MainKeyIcon2["default"], { id: 'wgldmlLocal', target: that, index: index });
	            } }]
	    }];
	    ...
	    callback({
	        ...
	        "data": [{
	            ...
	            "data": _react2["default"].createElement(_AiFormTable2["default"], { config: {
	                ...
	                }, id: 'wgldmlLocal', buttons: 'addModal', dataListId: 'metadataModal', form: target.props.form })
