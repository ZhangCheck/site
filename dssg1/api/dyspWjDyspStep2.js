	...
	(0, _jsonp2["default"])("dyspWjDyspStep2")(function (args, callback) {
	    ...
	    callback({
	        ...
	        "data": [{
	            ...
	            "data": [{ "name": "申请订阅原因", "type": "text", "field": "applyReason", "defaultValue": resSubscribeDTO.applyReason }, { "name": "申请设备", "type": "text", "field": "applyUser", "defaultValue": resSubscribeDTO.applyPerson }, { "name": "申请订阅时间", "type": "text", "field": "applyTime", "defaultValue": resSubscribeDTO.applyTime }]
	        }, {
	            "title": "资源订阅审批信息",
	            "column": 2,
	            "showTitle": true,
	            "titleIcon": "res-pub-mes",
	            "data": [{ "type": "text", "name": "审批结果", "field": "result",
	                "defaultValue": _global.Global.getState().aiForm.dyspWjDyspStep1.result == "0" ? "通过" : "拒绝" }, { "name": "审批意见", "type": "text", "field": "reviewDesc",
	                "defaultValue": _global.Global.getState().aiForm.dyspWjDyspStep1.reviewDesc }]
	        }]
	    });
	});
