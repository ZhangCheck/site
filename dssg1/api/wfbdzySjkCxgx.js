...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jsonp2["default"])("wfbdzySjkCxgx")(function (args, callback) {
	    ...
	    var detailMsg = state.dataList.wfbdzySjk && state.dataList.wfbdzySjk.detailMsgDataApi && state.dataList.wfbdzySjk.detailMsgDataApi.data ? state.dataList.wfbdzySjk.detailMsgDataApi.data : {};
	    ...
	    var zycxxx = detailMsg.processRecordRevocationDTO ? detailMsg.processRecordRevocationDTO : {};
	    var values = {};
	    values = (0, _extends3["default"])({}, values, { resourceId: detailMsg.id, type: "-1" });
	    ...
	    callback({
	        ...
	        "data": [{
	            ...
	            //     {"type":"text","name":"国家主题分类" ,"field":"subjectcarategory" ,"defaultValue":detailMsg.themeTypeName?detailMsg.themeTypeName:""},
	            //     {"type":"text","name":"部门主题分类" ,"field":"departmentcategory" ,"defaultValue":detailMsg.departmentTypeName?detailMsg.departmentTypeName:""},
	            ...
	            // ]
	            "data": _react2["default"].createElement(_BasicMessage2["default"], { subId: 'wfbdzySjkCxgx', showValues: metadataDetail, leftShow: 'false' })
	        }, {
	            "title": "资源发布信息",
	            "column": 2,
	            "showTitle": true,
	            ...
	            "buttonConfigs": {
	                ...
	                "buttons": [{ "type": "button", "value": "取消", props: { "style": { "float": "right" } } }, { "type": "button", "value": "撤销共享", field: "submit", props: { type: "primary", "style": { "float": "right" } } }]
	            },
	            "data": [{ "name": "撤销原因", "type": "input", "field": "applyReason", "defaultValue": zycxxx.applyReason ? zyfbxx.applyReason : "" }, { "name": "申请生效时间", "type": "datePicker", "field": "effectiveData", props: { showTime: true } }, { "name": "申请人", "type": "text", "field": "applyUser", "defaultValue": _global.Global.getState().framework.loginApi.data.loginUserProfileDTO.loginName }]
	        }]
	    });
	});
