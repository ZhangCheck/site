...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jsonp2["default"])("dyspApiStep1")(function (args, callback) {
	    ...
	    var config = {
	        ...
	        "data": [{
	            ...
	            "wrapperCol": 6,
	            "data": [{ "name": "申请单位", "labelCol": 8, "wrapperCol": 16, "type": "text", "field": "createComp", "defaultValue": resSubscribeDetail.company ? resSubscribeDetail.company : "" }, { "name": "订阅设备", "labelCol": 8, "wrapperCol": 16, "type": "text", "field": "createEqu", "defaultValue": resSubscribeDetail.equipmentName ? resSubscribeDetail.equipmentName : "" }, { "name": "联系人", "labelCol": 8, "wrapperCol": 16, "type": "text", "field": "linkman", "defaultValue": resSubscribeDetail.linkMan ? resSubscribeDetail.linkMan : "" }, { "name": "联系电话", "labelCol": 8, "wrapperCol": 16, "type": "text", "field": "phone", "defaultValue": resSubscribeDetail.phone ? resSubscribeDetail.phone : "" }, { "name": "申请原因", "labelCol": 8, "wrapperCol": 16, "type": "text", "field": "domainName", "defaultValue": resSubscribeDetail.applyReason ? resSubscribeDetail.applyReason : "" }, { "name": "请求时段", "labelCol": 8, "wrapperCol": 16, "type": "text", "field": "catalogName", "defaultValue": resSubscribeDetail.requestTime ? resSubscribeDetail.requestTime : "" }, { "name": "资源类型", "labelCol": 8, "wrapperCol": 16, "type": "text", "field": "resType", "defaultValue": resSubscribeDetail.resType == 1 ? "数据库" : resSubscribeDetail.resType == 2 ? "文件" : "API" }, { "name": "申请订阅时间", "labelCol": 8, "wrapperCol": 16, "type": "text", "field": "updataTime", "defaultValue": resSubscribeDetail.applyTime ? resSubscribeDetail.applyTime : "" }, { "name": "是否启用SSL", "labelCol": 8, "wrapperCol": 16, "type": "text", "field": "enableSsl", "defaultValue": resSubscribeDetail.enableSsl == 1 ? "是" : "否" }]
	        }]
	    };
