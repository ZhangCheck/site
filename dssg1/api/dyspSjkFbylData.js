...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jsonp2["default"])("dyspSjkFbylData")(function (args, callback) {
	    ...
	    var detailMsg = states.dataList.getDyspEdit && states.dataList.getDyspEdit.detailMsgDataApi && states.dataList.getDyspEdit.detailMsgDataApi.length > 0 ? states.dataList.getDyspEdit.detailMsgDataApi[0] : {};
	    ...
	    var gxmuxx = [{
	        "resName": detailMsg ? detailMsg.resName : "",
	        "resEname": detailMsg ? detailMsg.resEname : "",
	        "resCode": detailMsg ? detailMsg.resCode : "",
	        "resType": detailMsg ? detailMsg.resTypeName : "",
	        "themeType": detailMsg ? detailMsg.themeTypeName : "",
	        "departmentType": detailMsg ? detailMsg.departmentTypeName : "",
	        "resLevel": detailMsg ? detailMsg.resLevel : ""
	    }];

	    var gxmlsjx = detailMsg ? (0, _dataFormat.jsonStrToArray)(detailMsg.dbJson) ? (0, _dataFormat.jsonStrToArray)(detailMsg.dbJson) : [] : [];
	    var subscriber = [];
	    subscriber.push(detailMsg ? detailMsg.sysEquipmentSubscribeDTO ? detailMsg.sysEquipmentSubscribeDTO : {} : {});
	    var subContent = detailMsg.resSubscribeDTO && detailMsg.resSubscribeDTO.subDataJson ? (0, _dataFormat.jsonStrToArray)(detailMsg.resSubscribeDTO.subDataJson) : [];
	    ...
	    var tableJson = (0, _dataFormat.jsonStrToArray)(_global.Global.getState().dataList.getDyspEdit.detailMsgDataApi[0].subscribeColumn);
	    ...
	    sjglOld.forEach(function (item) {
	        tableJson.forEach(function (item1) {
	            var columnName = item1.table + "." + item1.columnName;
	            if (columnName == item.columnName1 && item1.pk != true) {
	                var _sjgl$push;

	                sjgl.push((_sjgl$push = {
	                    "resourceName": item.resourceName1,
	                    "columnName": item.columnName1,
	                    "columnType": item1.type
	                }, (0, _defineProperty3["default"])(_sjgl$push, 'columnType', item1.type), (0, _defineProperty3["default"])(_sjgl$push, "columnEnName", item.columnEnName1), (0, _defineProperty3["default"])(_sjgl$push, "operators", item.operators1), (0, _defineProperty3["default"])(_sjgl$push, "value", item.value1), _sjgl$push));
	                return;
	            }
	        });
	    });
	    sjzhOld.forEach(function (item) {
	        tableJson.forEach(function (item1) {
	            var columnName = item1.table + "." + item1.columnName;
	            if (columnName == item.columnName2 && item1.pk != true) {
	                sjzh.push({
	    ...
	    sjtmlOld.forEach(function (item) {
	        tableJson.forEach(function (item1) {
	            var columnName = item1.table + "." + item1.columnName;
	            if (columnName == item.columnName3 && item1.pk != true) {
	                sjtm.push({
	                    "resourceName": item.resourceName3,
	                    "columnName": item.columnName3,
	                    "columnEnName": item.columnEnName3,
	                    "columnType": item1.type,
	    ...
	    var subSendEquipment = zydyxx.subSendEquipment ? zydyxx.subSendEquipment : "";
	    values = (0, _extends3["default"])({}, values, { dbProcessStrategyJson: dbProcessStrategyJson, resourceId: detailMsg ? detailMsg.id : 'null', subSendEquipment: subSendEquipment });
	    ...
	    callback({
	        ...
	        "data": [{
	            ...
	            "showTitle": true,
	            "data": [{ "type": "text", "name": "申请订阅原因", "field": "applyReason", "defaultValue": zydyxx.applyReason ? zydyxx.applyReason : "" }, { "type": "text", "name": "申请设备", "field": "applyPerson", "defaultValue": zydyxx.applyPerson ? zydyxx.applyPerson : "adasd" }, { "type": "text", "name": "申请订阅时间", "field": "applyTime", "defaultValue": zydyxx.applyTime ? zydyxx.applyTime : "" }, { "type": "text", "name": "审批结果", "field": "result", "defaultValue": values.result == "0" ? "通过" : "拒绝" }, { "type": "text", "name": "审批意见", "field": "approvalOpinion", "defaultValue": values.approvalOpinion ? values.approvalOpinion : "" }, { "type": "text", "name": "审批时间", "field": "revokeTime", "defaultValue": zydyxx.revokeTime ? zydyxx.revokeTime : "" }]
	        }]
	    });
	});
