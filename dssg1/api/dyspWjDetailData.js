...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jsonp2["default"])("dyspWjDetailData")(function (args, callback) {
	    ...
	    ysjBasicInf.pictureUrl = values.pictureUrl ? values.pictureUrl : "";
	    ...
	    var resSubscribeDTO = values.resSubscribeDTO ? values.resSubscribeDTO : {};
	    var subscriber = [];
	    var zyyxq = [];
	    zyyxq.push({
	        "zyyxq": "",
	        "validBeginTime": values.validBeginTime,
	        "validEndTime": values.validEndTime
	    });
	    if (values.sysEquipmentSubscribeDTO) {
	        subscriber.push(values.sysEquipmentSubscribeDTO);
	    }
	    //共享文件信息
	    var fileDatasArr = [];
	    ...
	    callback({
	        ...
	        "data": [{
	            ...
	            "data": _react2["default"].createElement(_BasicMessage2["default"], { showValues: ysjBasicInf, subId: 'dyspWj', leftShow: 'true' })
	        }, {
	            "title": "共享文件信息",
	            "showTitle": true,
	            "titleIcon": "catalog",
	            ...
	            "data": [{ "name": "申请订阅原因", "type": "text", "field": "applyReason", "defaultValue": resSubscribeDTO.applyReason ? resSubscribeDTO.applyReason : "" }, { "name": "申请设备", "type": "text", "field": "applyUser", "defaultValue": resSubscribeDTO.applyPerson ? resSubscribeDTO.applyPerson : "" }, { "name": "申请订阅时间", "type": "text", "field": "applyTime", "defaultValue": resSubscribeDTO.applyTime ? resSubscribeDTO.applyTime : "" }, { "type": "text", "name": "审批结果", "field": "result", "defaultValue": resSubscribeDTO.state ? resSubscribeDTO.state == 1 ? '通过' : resSubscribeDTO.state == 2 ? '拒绝' : '' : '' }, { "type": "text", "name": "审批意见", "field": "approvalOpinion", "defaultValue": resSubscribeDTO.approvalOpinion ? resSubscribeDTO.approvalOpinion : "" }, { "type": "text", "name": "审批时间", "field": "revokeTime", "defaultValue": resSubscribeDTO.approvalTime ? resSubscribeDTO.approvalTime : "" }]
	        }]
	    });
	});
