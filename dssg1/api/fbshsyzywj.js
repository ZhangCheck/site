...
/***/ function(module, exports, __webpack_require__) {
	...
	var _css = __webpack_require__(1926);
	    ...
	    callback({
	        ...
	        "data": {
	                            ...
	                            _react2["default"].createElement(
	                                ...
	                                _react2["default"].createElement(
	                                    ...
	                                    { onClick: function onClick() {
	                                            ...
	                                            var result3 = (0, _dataFormat.checkTableOneData)(_global.Global, "fbshsyzywj", "state", "3");
	                                            if (!result3) {
	                                                _modal2["default"].warning({
	                                                    title: '提示',
	                                                    content: '资源已拒绝！'
	            ...
	            "searchConfig": {
	                "data": [{
	                    "column": 6,
	                    "data": [{ "type": "input", "col": 7, "name": "资源名称/编码：", "field": "resName" }, { "type": "treeSelect", "col": 6, "name": "国家主题分类", options: { value: "_all_", key: "全部" }, "field": "themeType", dictId: "themeType", "placeholder": "请选择...", dictApi: { apiName: 'flglDataTree', body: { categoryType: 1 } } }, { "type": "select", "col": 4, "name": "状态", "field": "state",
	                        "options": [{ value: "_all_", key: "全部" }, { value: 1, key: "待审核" }, { value: 2, key: "发布" }, { value: 3, key: "发布拒绝" }, { value: "9", key: "已过期" }]
	                    }, { "type": "select", "col": 5, "name": "申请时间", "field": "applyTime", options: [{ value: "_all_", key: "全部" }, { value: "1", key: "最近一周" }, { value: "2", key: "最近一月" }, { value: "3", key: "最近三月" }, { value: "4", key: "最近一年" }] }, { "type": "button", "col": 1, "value": "查询", "pageName": "search", "btnType": "primary", "htmlType": "submit" }]
	                }],
