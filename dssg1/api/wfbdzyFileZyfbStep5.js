...
/***/ function(module, exports, __webpack_require__) {
	...
	var _css3 = __webpack_require__(2455);
	...
	*/
	...
	(0, _jsonp2["default"])("wfbdzyFileZyfbStep5")(function (args, callback) {
	    ...
	    // resourceTimes.startTime = times.startTime.format('YYYY-MM-DD HH:mm:ss');
	    // resourceTimes.endTime = times.endTime.format('YYYY-MM-DD HH:mm:ss');
	    resourceTimes.push({ "dispatchType": '资源有效期', "startTime": times.validBeginTime.format('YYYY-MM-DD HH:mm:ss'),
	        "endTime": times.validEndTime.format('YYYY-MM-DD HH:mm:ss') });
	    //共享文件信息
	    ...
	    callback({
	        ...
	        "data": [{
	            ...
	            "data": _react2["default"].createElement(_BasicMessage2["default"], { subId: 'wfbdzyFileZyfbStep5', showValues: ysjBasicInf, leftShow: 'false' })
	        }, {
	            "title": "共享文件信息",
	            "showTitle": true,
	            "titleIcon": "catalog",
