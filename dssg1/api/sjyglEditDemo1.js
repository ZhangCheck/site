...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jsonp2["default"])("sjyglEditDemo1")(function (args, callback) {
	    ...
	    callback({
	        ...
	        "data": [{
	            ...
	            "buttonConfigs": {
	                "onSubmitApi": { apiName: "sjyglEditData", body: (0, _extends3["default"])({}, values) },
	                ...
	                "buttons": [{ "type": "button", "value": "取消", mark: "sjygl", props: { "style": { "float": "right" } } }, { "type": "button", "value": "确定", mark: "sjygl", props: { type: "primary", "style": { "float": "right" }, htmlType: "submit" }
	                            ...
	                            _global.Global.getState().aiForm.sjyglEditDemo1.config.data[0].buttonConfigs.buttons[2].props.disabled = true;
	                            _global.Global.getState().aiForm.sjyglEditDemo1.config.data[0].buttonConfigs.buttons[2].value = "连接中...";

	                            _global.Global.requestApi((0, _extends3["default"])({}, _interfaces.dataSourceByObjTest, { body: (0, _extends3["default"])({}, _global.Global.getState().aiForm.sjyglEditDemo1 ? _global.Global.getState().aiForm.sjyglEditDemo1.form.getFieldsValue() : _global.Global.getState().aiForm.sjyglEditDemo1.form.getFieldsValue()),
	                                next: function next(action) {
	                                    _global.Global.getState().aiForm.sjyglEditDemo1.config.data[0].buttonConfigs.buttons[2].props.disabled = false;
	                                    _global.Global.getState().aiForm.sjyglEditDemo1.config.data[0].buttonConfigs.buttons[2].value = "测试连接";
	                                }
