...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jsonp2["default"])("datalistDemoLayout3Zyck")(function (args, callback) {
	    var state = _global.Global.getState();
	    var values = state.dataList.datalistDemoLayout3.detailMsgDataApi && state.dataList.datalistDemoLayout3.detailMsgDataApi.data ? state.dataList.datalistDemoLayout3.detailMsgDataApi.data : {};
	    ...
	    zyyxq.push({
	        "zyyxq": "",
	        "validBeginTime": _global.Global.getState().dataList.datalistDemoLayout3.detailMsgDataApi.data.validBeginTime,
	        "validEndTime": _global.Global.getState().dataList.datalistDemoLayout3.detailMsgDataApi.data.validEndTime
	    });
	    //更新策略
	    var ddModelDatas = [];
	    ...
	    callback({
	        ...
	        "data": [{
	            ...
	            "data": _react2["default"].createElement(_BasicMessage2["default"], { subId: 'wfbdzyFile', showValues: ysjBasicInf, leftShow: true })
	        }, {
	            "title": "共享文件信息",
	            "showTitle": true,
	            "childrenContentNoBorder": true,
	            ...
	            "data": [{ "name": "发布原因", "type": "text", "labelCol": 8, "wrapperCol": 16, "field": "reason", "defaultValue": processRecordDTO.applyReason }, { "name": "申请人", "type": "text", "labelCol": 8, "wrapperCol": 16, "field": "applyUser", "defaultValue": processRecordDTO.applyUser }, { "name": "申请时间", "type": "text", "labelCol": 8, "wrapperCol": 16, "field": "applyTime", "defaultValue": processRecordDTO.applyTime }, { "name": "审核结果", "type": "text", "labelCol": 8, "wrapperCol": 16, "field": "result", "defaultValue": processRecordDTO.result == null ? " " : processRecordDTO.result == "0" ? "通过" : "拒绝" }, { "name": "审核意见", "type": "text", "labelCol": 8, "wrapperCol": 16, "field": "reviewDesc", "defaultValue": processRecordDTO.reviewDesc }, { "name": "审核时间", "type": "text", "labelCol": 8, "wrapperCol": 16, "field": "reviewTime", "defaultValue": processRecordDTO.reviewTime }]
	        }]
	    });
	});
