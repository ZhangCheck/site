...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	(0, _jsonp2["default"])("wscdzyWjzyck")(function (args, callback) {
	    var state = _global.Global.getState();
	    var values = state.dataList.wscdzyWj.detailMsgDataApi && state.dataList.wscdzyWj.detailMsgDataApi.data ? state.dataList.wscdzyWj.detailMsgDataApi.data : {};
	    var ysjBasicInf = values ? values.metadataDTO : {};
	    ysjBasicInf.resType = values.resType;
	    ysjBasicInf.pictureUrl = ysjBasicInf.pictureUrl;
	    ...
	    callback({
	        ...
	        "data": [{
	            ...
	            //     {"type":"text","name":"国家主题分类" ,"field":"themeTypeName" ,"defaultValue":themeTypeName},
	            //     {"type":"text","name":"部门主题分类" ,"field":"departmentTypeName" ,"defaultValue":departmentTypeName},
	            ...
	            // ]
	            "data": _react2["default"].createElement(_BasicMessage2["default"], { showValues: ysjBasicInf, subId: 'wscdzyWjzyck', leftShow: 'true' })
	        }, {
	            "title": "共享文件信息",
	            "showTitle": true,
	            "titleIcon": "catalog",
