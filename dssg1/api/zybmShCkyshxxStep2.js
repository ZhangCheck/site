...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jsonp2["default"])("zybmShCkyshxxStep2")(function (args, callback) {
	    var states = _global.Global.getState();
	    var target = args.target;
	    var detailValue = states.aiForm && states.aiForm.zybmShCkbmsqStep1 && states.aiForm.zybmShCkbmsqStep1.detailMsgDataApi ? states.aiForm.zybmShCkbmsqStep1.detailMsgDataApi.data : {};
	    detailValue.filePath = detailValue.filePath && detailValue.filePath != "" ? detailValue.filePath : detailValue.pictureUrl;
	    var metadataDetail = (0, _extends3["default"])({}, detailValue);
	    var config = [{
	        "title": "元数据基本信息",
	        "showTitle": false,
	    ...
	    if (detailValue.resType == "1") {
	        var dataSource = (0, _dataFormat.jsonStrToArray)(detailValue.dbJson);
	        dataSource.length > 0 && dataSource.map(function (valueData, index) {
	        ...
	        config[1] = {
	            ...
	            "data": function data() {
	                return _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(_table2["default"], { columns: zybmglCloumns, dataSource: dataSource, key: 'zybmglAdd', bordered: true, pagination: false })
	                );
	            }
