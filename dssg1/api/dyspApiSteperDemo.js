...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jsonp2["default"])("dyspApiSteperDemo")(function (args, callback) {
	    var states = _global.Global.getState();
	    var list = states.aiForm.dyspApiStep1;
	    var step = states.stepContainer.dyspApiSteperDemo.step;
	    if (!list && step != 1) {
	        _StepContainerV2["default"]["goto"]('dyspApiSteperDemo', "datalistV1/zydysplb/list/11/10");
	    }
	    callback({
	        "success": true,
	        "data": {
	            ...
	            "afterSave": "datalistV1/zydysplb/list/11/10",
	            "steps": [{
	                "type": "aiForm",
	                "configStepApi": "dyspApiStep1",
	                "number": "1",
	                "name": "查看请求方信息",
	                "id": "dyspApiStep1",
	                "footer": ["next", "cancel"],
	                ...
	                "validate": function validate() {
	                    var form = _global.Global.getState().aiForm.dyspApiStep5.form;
	                    ...
	                    if (validate) {
	                        _global.Global.mark({ aiForm: { dyspApiStep5: { values: (0, _extends3["default"])({}, values) } } });
	                    }
	                    return validate;
	                }
	            }, {
	                "arg": {},
	                "type": "aiForm",
	                "configStepApi": "dyspApiStep6",
	                "number": "6",
	                "name": "填写审批意见",
	                "id": "dyspApiStep6",
	                "validate": function validate() {
	                    var form = _global.Global.getState().aiForm.dyspApiStep6.form;
	                    var values = form.getFieldsValue();
	                    var validate = false;
	                    form.validateFields(function (fileds) {
	                        validate = !fileds;
	                    ...
	                    if (validate) {
	                        var apiConfig = (0, _extends3["default"])({}, _interfaces.dyspSubmit, {
	                            body: (0, _extends3["default"])({}, _interfaces.dyspSubmit.body, _global.Global.getState().aiForm.dyspApiStep6.values, values) });
	                        return apiConfig;
	                    }
	                }
	            }]
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Rect = __webpack_require__(1623);
