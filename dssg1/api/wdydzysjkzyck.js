...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jsonp2["default"])("wdydzysjkzyck")(function (args, callback) {
	    ...
	    var allData = state.dataList.wdydzySjk.detailMsgDataApi ? state.dataList.wdydzySjk.detailMsgDataApi.data : {};
	    ...
	    var subscriber = [];
	    if (allData.sysEquipmentSubscribeDTO) {
	        subscriber.push(allData.sysEquipmentSubscribeDTO);
	    }
	    var subContent = allData && allData.resSubscribeDTO.subDataJson ? (0, _dataFormat.jsonStrToArray)(allData.resSubscribeDTO.subDataJson) : [];
	    var zyyxq = [];
	    zyyxq.push({
	        "zyyxq": "",
	    ...
	    var gxmuxx = [{
	        "resName": allData.resName ? allData.resName : "",
	        "resEname": allData.resEname ? allData.resEname : "",
	        "resCode": allData.resCode ? allData.resCode : "",
	        "resType": allData.resTypeName ? allData.resTypeName : "",
	        "themeType": allData.themeTypeName ? allData.themeTypeName : "",
	        "departmentType": allData.departmentTypeName ? allData.departmentTypeName : "",
	        "resClassDirName": allData.resClassDirName ? allData.resClassDirName : "",
	        "resLevel": allData.resLevel ? allData.resLevel : ""
	    }];
	    ...
	    //let subscriber = allData ? allData.subscriber:[];
	        ...
	        "data": [{
	            ...
	            "data": function data() {
	                return _react2["default"].createElement(
	                    'div',
	                    { className: "customizedTable" },
	                    _react2["default"].createElement(_table2["default"], { pagination: false, columns: dyyhCloumn, dataSource: subscriber, bordered: true })
	                );
	            }
	        }, {
	            "title": "订阅内容",
	            ...
	            "data": function data() {
	                return _react2["default"].createElement(
	                    'div',
	                    { className: "customizedTable" },
	                    _react2["default"].createElement(_table2["default"], { columns: gxmlsjxCloumn, dataSource: subContent, bordered: true })
	                );
	            }
	        }, {
	            "title": "订阅数据处理策略",
	            ...
	            "data": function data() {
	                return _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(_table2["default"], { columns: sjglcolumns, pagination: false, dataSource: sjclcl.dataFilteing || [], bordered: true }),
	                    _react2["default"].createElement(
	                        'div',
	                        { className: "tableTitle" },
	                        _react2["default"].createElement(_icon2["default"], { type: 'appstore-o', className: "tableTitIcon" }),
	                    ...
	                    _react2["default"].createElement(_table2["default"], { columns: sjzhcolumns, pagination: false, dataSource: sjclcl.dataConversion || [], bordered: true }),
	                    _react2["default"].createElement(
	                        'div',
	                        { className: "tableTitle" },
	                        _react2["default"].createElement(_icon2["default"], { type: 'appstore-o', className: "tableTitIcon" }),
	                    ...
	                    _react2["default"].createElement(_table2["default"], { columns: sjtmcolumns, pagination: false, dataSource: sjclcl.dataDesen || [], bordered: true })
	                );
	            }
	        }, {
	            "title": "资源订阅信息",
	            ...
	            "data": [{ "name": "申请订阅原因", "type": "text", "field": "applyReason", "defaultValue": allData.resSubscribeDTO ? allData.resSubscribeDTO.applyReason : '' }, { "name": "申请人", "type": "text", "field": "applyPerson", "defaultValue": allData.resSubscribeDTO ? allData.resSubscribeDTO.applyPerson : '' }, { "name": "申请订阅时间", "type": "text", "field": "applyTime", "defaultValue": allData.resSubscribeDTO ? allData.resSubscribeDTO.applyTime : '' }, { "name": "审批结果", "type": "text", "field": "result", "defaultValue": allData.resSubscribeDTO ? allData.resSubscribeDTO.state != 0 ? allData.resSubscribeDTO.state == 1 ? '通过' : '拒绝' : '' : '' }, { "name": "审批意见", "type": "text", "field": "approvalOpinion", "defaultValue": allData.resSubscribeDTO ? allData.resSubscribeDTO.approvalOpinion : '' }, { "name": "审批时间", "type": "text", "field": "approvalTime", "defaultValue": allData.resSubscribeDTO ? allData.resSubscribeDTO.approvalTime : '' }],
	            "buttonConfigs": {
