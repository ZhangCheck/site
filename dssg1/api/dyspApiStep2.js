...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jsonp2["default"])("dyspApiStep2")(function (args, callback) {
	    ...
	    config[1] = {
	        ...
	        "data": function data() {
	            return _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(_table2["default"], { columns: requestColumns, dataSource: requestParams, key: 'zybmglReq', pagination: false })
	            );
	        }
	    ...
	    config[2] = {
	        ...
	        "data": function data() {
	            return _react2["default"].createElement(
	                'div',
	                { className: "customizedTable2" },
	                _react2["default"].createElement(_table2["default"], { columns: responseColumns, dataSource: responseStruct, key: 'zybmglRes', pagination: false })
	            );
	        }
