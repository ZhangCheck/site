...
/***/ function(module, exports, __webpack_require__) {
	...
	var _css = __webpack_require__(1666);
	...
	(0, _jsonp2["default"])("apijkwfbdzy")(function (args, callback) {
	        ...
	        "data": {
	                            ...
	                            _react2["default"].createElement(
	                                ...
	                                _react2["default"].createElement(
	                                    ...
	                                    { onClick: function onClick() {
	                                            var result = (0, _dataFormat.checkSelectId)(_global.Global, "apijkwfbdzy");
	                                            if (!result) {
	                                                ...
	                                                var flag1 = (0, _dataFormat.checkTableOneData)(_global.Global, 'apijkwfbdzy', 'state', -1);
	                                                var flag2 = (0, _dataFormat.checkTableOneData)(_global.Global, 'apijkwfbdzy', 'stateSubs', -1);
	                                                if (!flag1) {
	                                                    _modal2["default"].warning({
	                                                        content: '已经是暂停状态！'
	                                                    });
	                                                    ...
	                                                    _modal2["default"].warning({
	                                                        content: '该服务任务已经被订阅方暂停！'
	                                                    });
	                                                    return false;
	                                                }

	                                                var _state = _global.Global.getState();
	                                                var selecetId = _state.dataList.apijkwfbdzy.selectedRows;
	                                                _modal2["default"].confirm({
	                                                    title: '告警信息',
	                                                    content: '确认暂停？',
	                                                    onOk: function onOk() {
	                                                        var body = { id: selecetId[0], state: -1, actionType: 1 };
	                                ...
	                                _react2["default"].createElement(
	                                    ...
	                                    { onClick: function onClick() {
	                                            ...
	                                            if (!result) {
	                                                ...
	                                                var flag1 = (0, _dataFormat.checkTableOneData)(_global.Global, 'apijkwfbdzy', 'state', 0);
	                                                var flag2 = (0, _dataFormat.checkTableOneData)(_global.Global, 'apijkwfbdzy', 'stateSubs', 0);
	                                                if (!flag1 && !flag2) {
	                                                    _modal2["default"].warning({
	                                                        content: '已经是启用状态！'
	                                                    });
	                                                ...
	                                                var selecetId = _state2.dataList.apijkwfbdzy.selectedRows;
	                                                _modal2["default"].confirm({
	                                                    title: '告警信息',
	                                                    content: '确认启用？',
	                                                    onOk: function onOk() {
	                                                        var body = { id: selecetId[0], state: 0, actionType: 1 };
	                                                        _global.Global.requestApi({ "apiName": "startStopService", body: (0, _extends3["default"])({}, body) }, ["requestResState", "receiveResState", "failedResState"], {});
	                                                    },
	                                                    onCancel: function onCancel() {
	                                                        console.log("delete exit!!!");
	            ...
	            "searchConfig": {
	                "data": [{
	                    ...
	                    "data": [{ "type": "input", "col": 6, "name": "API接口服务", "field": "taskName" }, {
	                        "type": "button",
	                        "col": 2,
	                        "value": "查询",
	                        "pageName": "search",
	            ...
	            "table": {
	                ...
	                "clounms": [{
	                    ...
	                    "render": function render(text, recode, index) {
	                        var state = _global.Global.getState().dataList.apijkwfbdzy;
	                        return _react2["default"].createElement(
	                            'div',
	                            null,
	                ...
	                "body": { apiName: 'myPublishResourceByPage' }
	            },
	            "list": {
	                "view": null,
	                "listApi": null,
