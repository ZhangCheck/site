...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jsonp2["default"])("jhrzwdydZY")(function (args, callback) {
	    ...
	    if (roleCode.indexOf("ADMIN") > 0 || roleCode.indexOf("MANAGER") > 0) {
	        ...
	        _history2["default"].push("datalistV1/jhrzwfbdZY/list/0/10");
	    } else {
	        tabData = [{
	            show: "1",
	            urlPart: "jhrzwdydZY",
	    ...
	    callback({
	        ...
	        "data": {
	            ...
	            "buttonConfigs": [{ "buttonName": function buttonName(config) {
	                    return _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            ...
	                            _react2["default"].createElement(
	                                _Download2["default"],
	                                { body: { type: 2, ids: _global.Global.getState().dataList.jhrzwdydZY && _global.Global.getState().dataList.jhrzwdydZY.selectedRows ? _global.Global.getState().dataList.jhrzwdydZY.selectedRows : [] }, method: 'POST', name: '\u4EA4\u6362\u65E5\u5FD7.xls', src: _interfaces.server + "exchangeLog/exportExcel" },
	                                _react2["default"].createElement(
	                                    'a',
	                                    null,
	                                    '\u5BFC\u51FA'
	            ...
	            "searchConfig": {
	                ...
	                "body": { apiName: 'findExchangeLogSubscribe' }
	            },
	            "table": {
	                "primarykey": "id",
	                "clounms": [{
	                    ...
	                    render: function render(text, record, index) {
	                        var glState = _global.Global.getState().dataList.jhrzwdydZY;
	                        return _react2["default"].createElement(
	                            'div',
	                            null,
	                        ...
	                        return _react2["default"].createElement(
	                            ...
	                            { title: text, style: { width: _global.Global.getState().framework.columnWidth, cursor: "pointer", display: "inline-block", color: "#1f94e4", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" },
	                                ...
	                                onClick: function onClick() {
	                                    ...
	                                    _global.Global.mark({ dataList: { listName: "jhrzwdydZY" } });
	                                    //history.push("/aiForm/metadata/getMetadataDetail/metadataDetail");
	                                    _global.Global.dispatch((0, _dataList.showDetailDlg)('jhrzwdydZY', record.id, '查看任务'));
	                                }
	                            },
	                            '\u8BE6\u60C5'
	                        );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _css = __webpack_require__(1995);
