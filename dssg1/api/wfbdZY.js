...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jsonp2["default"])("wfbdZY")(function (args, callback) {
	    ...
	    if (roleCode.indexOf("ADMIN") > 0 || roleCode.indexOf("MANAGER") > 0) {
	        ...
	        _history2["default"].push("datalistV1/wdydZY/list/0/10");
	    }
	    callback({
	        "success": true,
	        "data": {
	                                ...
	                                _react2["default"].createElement(
	                                    ...
	                                    { onClick: function onClick() {
	                                            ...
	                                            if (!result) {
	                                                ...
	                                                var flag2 = (0, _dataFormat.checkTableOneData)(_global.Global, 'wfbdZY', 'state', 5);
	                                                if (!flag2) {
	                                                    _modal2["default"].warning({
	                                                        content: '该任务已经被订阅方暂停！'
	                                                    });
	            ...
	            "searchConfig": {
	                "data": [{
	                    ...
	                    "data": [{ "type": "input", "col": 5, "name": "任务名称", "field": "taskName" }, {
	                        "type": "button",
	                        "col": 4,
	                        "value": "查询",
	                        "pageName": "search",
	            ...
	            "table": {
	                ...
	                "clounms": [{
	                    ...
	                    render: function render(text, record, index) {
	                        var glState = _global.Global.getState().dataList.wfbdZY;
	                        return _react2["default"].createElement(
	                            'div',
	                            null,
