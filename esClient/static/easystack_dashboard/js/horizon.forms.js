...
// switches domain id when domain changes 	118
// TODO(esp): $("#id_project") needs to be filtered but we don't have 	119
// project domain id 	120
...
horizon.forms.init_examples = function (el) {
  ...
  // Subnet create form.
  $el.find("#id_cidr").attr("placeholder", gettext("192.168.0.0/24"));
  $el.find("#id_gateway_ip").attr("placeholder", gettext("192.168.0.1"));
};
