(function () {
  ...
  var module = angular.module('hz.dashboard.aws-launch-instance');
  ...
  module.factory('AwslaunchInstanceModel', ['$q', '$log', '$rootScope',
      ...
      function initialize(deep) {
        ...
        if (model.initializing) {
          ...
          promise = $q.all([
            ...
            novaAPI.getFlavors(true, false).then(onGetFlavors, noop),
