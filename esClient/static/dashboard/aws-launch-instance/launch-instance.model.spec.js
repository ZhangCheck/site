...
(function() {
  ...
  describe('Aws Launch Instance Model', function() {

    describe('AwslaunchInstanceModel Factory', function() {
      var model;
      var scope;
      var $q;
      ...
      beforeEach(inject(function(AwslaunchInstanceModel, $rootScope, _$q_) {
        model = AwslaunchInstanceModel;
        $q = _$q_;
        scope = $rootScope.$new();
      }));
