...
(function() {
  ...
  describe('Launch Instance Source Step', function() {
    ...
    describe('AwsLaunchInstanceSourceController', function() {
      ...
      beforeEach(inject(function($controller, $rootScope, _$browser_, $q) {
        ...
        ctrl = $controller('AwsLaunchInstanceSourceController', { $scope: scope });
    ...
    describe('AwsLaunchInstanceSourceHelpController', function() {
      var ctrl;

      beforeEach(inject(function($controller) {
        ctrl = $controller('AwsLaunchInstanceSourceHelpController', {});
      }));
