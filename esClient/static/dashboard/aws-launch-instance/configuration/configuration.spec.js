...
(function() {
  ...
  describe('Launch Instance Configuration Step', function() {
    ...
    describe('AwsLaunchInstanceConfigurationController', function() {
      var scope;
      var ctrl;
      ...
      beforeEach(inject(function($controller) {
        ...
        ctrl = $controller('AwsLaunchInstanceConfigurationController', {
          $scope: scope
        });
      }));
    ...
    describe('AwsLaunchInstanceConfigHelpController', function() {
      var ctrl;

      beforeEach(module('hz.dashboard.aws-launch-instance'));

      beforeEach(inject(function($controller) {
        ctrl = $controller('AwsLaunchInstanceConfigHelpController');
      }));
