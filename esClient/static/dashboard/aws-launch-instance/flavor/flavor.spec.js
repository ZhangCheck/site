...
(function () {
  ...
  describe('Launch Instance Flavor Step', function () {
    describe('AwsLaunchInstanceFlavorController', function () {
      var ctrl, scope, model, defaults;

      beforeEach(module('hz.dashboard.aws-launch-instance'));
      ...
      beforeEach(inject(function ($controller, $rootScope) {
        ...
        ctrl = $controller('AwsLaunchInstanceFlavorController as selectFlavorCtrl',
                           { $scope:scope,
                             'horizon.framework.widgets.charts.quotaChartDefaults': defaults,
                             AwslaunchInstanceModel: model });
      }));
    ...
    describe('AwsLaunchInstanceFlavorHelpController', function () {
      var ctrl;

      beforeEach(module('hz.dashboard.aws-launch-instance'));

      beforeEach(inject(function ($controller) {
        ctrl = $controller('AwsLaunchInstanceFlavorHelpController', {});
      }));
