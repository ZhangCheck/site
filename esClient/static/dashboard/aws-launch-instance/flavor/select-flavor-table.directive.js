...
(function () {
  ...
  angular
    ...
    .directive('selectAwsFlavorTable', selectAwsFlavorTable)
    .directive('awsSlideSelectFlavor', awsSlideSelectFlavor);

  selectAwsFlavorTable.$inject = [
    'dashboardBasePath',
    'horizon.framework.widgets.transfer-table.helpText',
    'horizon.framework.widgets.charts.donutChartSettings'
  ];
  
  awsSlideSelectFlavor.$inject = [
    'dashboardBasePath',
   ...
   * '''
   */
  function selectAwsFlavorTable(path, transferTableHelpText, donutChartSettings) {
    ...
    var directive = {
      ...
      templateUrl: path + 'aws-launch-instance/flavor/select-flavor-table.html'
    };
  ...
  function awsSlideSelectFlavor(path){
    var directive = {
      restrict:   'EA',
      link:       link,
      ...
      templateUrl:   path + 'aws-launch-instance/flavor/setFlavor.html'
    };
