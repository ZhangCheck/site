...
(function () {
  ...
  function LaunchInstanceFlavorHelpController() {
    ...
    ctrl.paragraphs = [
      ...
      gettext('The flavor you select for a baremetal instance determines the amount of compute, storage and memory resources that will be carved out for the baremetal instance.'),
