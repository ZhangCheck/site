...
(function () {
  ...
  function LaunchInstanceNetworkHelpController() {
    ...
    ctrl.paragraphs = [
      ...
      gettext('An <b>External</b> network is set up by an administrator. If you want a baremetal instance to communicate outside of the data center, then attach a router between your <b>Project</b> network and the <b>External</b> network.'),
      gettext('A floating IP allows baremetal instances to be addressable from an external network. Floating IPs are not allocated to baremetal instances at creation time and may be assigned after the baremetal instance is created. To attach a floating IP, go to the <b>Baremetal Instances</b> view and click the <b>Actions</b> menu to the right of a baremetal instance. Then, select the <b>Associate Floating IP</b> option and enter the necessary details.'),
