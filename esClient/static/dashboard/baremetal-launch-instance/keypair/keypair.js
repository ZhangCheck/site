(function () {
  ...
  function LaunchInstanceKeypairCtrl($scope,
    ...
    ctrl.label = {
      ...
      subtitle: gettext('If your baremetal instance image is linux type,you are setting root password. A key pair or password allows you to login your newly created baremetal instance. You may set a password, select an existing key pair, import a key pair, or generate a new key pair.'),
    ...
    ctrl.createKeyPair = function () {
      $modal.open({
        templateUrl: dashboardBasePath + 'baremetal-launch-instance/keypair/create-keypair.html',
        controller: 'LaunchBareInstanceCreateKeyPairCtrl as ctrl',
    ...
    ctrl.importKeyPair = function () {
      $modal.open({
        templateUrl: dashboardBasePath + 'baremetal-launch-instance/keypair/import-keypair.html',
        controller: 'LaunchBareInstanceImportKeyPairCtrl as ctrl',
        windowClass: 'modal-dialog-wizard'
      }).result.then(
        function (result) {
          // Nova doesn't set the id in the response so we will use
  ...
  function LaunchInstanceKeypairHelpCtrl() {
    ...
    ctrl.paragraphs = [
      gettext('The key pair allows you to SSH into the baremetal instance.'),
  ...
  module.controller('LaunchBareInstanceCreateKeyPairCtrl', [
    ...
    LaunchBareInstanceCreateKeyPairCtrl
  ]);

  function LaunchBareInstanceCreateKeyPairCtrl($modalInstance, novaAPI, toastService, keypairDownloadService) {
    var ctrl = this;
    ...
    ctrl.labels = {
      ...
      // jscs:disable maximumLineLength
      help: gettext('Key Pairs are how you login to your baremetal instance after it is launched. Choose a key pair name you will recognize.'),
      // jscs:enable maximumLineLength
  ...
  module.controller('LaunchBareInstanceImportKeyPairCtrl', [
    ...
    'horizon.openstack-service-api.nova',
    'horizon.framework.widgets.toast.service',
    LaunchBareInstanceImportKeyPairCtrl
  ]);

  function LaunchBareInstanceImportKeyPairCtrl($modalInstance, novaAPI, toastService) {
    var ctrl = this;
    ...
    ctrl.labels = {
      ...
      // jscs:disable maximumLineLength
      help: gettext('Key Pairs are how you login to your baremetal instance after it is launched. Choose a key pair name you will recognize and paste your SSH public key into the space provided.'),
      // jscs:enable maximumLineLength
      keyPairName: gettext('Key Pair Name'),
      publicKey: gettext('Public Key'),
      cancel: gettext('Cancel'),
