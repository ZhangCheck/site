...
(function () {
  ...
  function LaunchInstanceConfigurationController() {
    ...
    ctrl.label = {
      subtitle: gettext("You can customize your baremetal instance after it has launched using the options available here.'Customization Script' is analogous to 'User Data' in other systems."),
      ...
      propOf: gettext('of'),
      helpTxt1: gettext('Custom scripts are attached to baremetal instances to perform specific actions when the baremetal instance is launched. For example, if you are unable to install <samp>cloud-init</samp> inside a guest operating system, you can use a custom script to get a public key and add it to the user account.'),
