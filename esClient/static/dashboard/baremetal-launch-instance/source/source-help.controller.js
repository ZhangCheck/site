...
(function () {
  ...
  function LaunchInstanceSourceHelpController() {
    ...
    ctrl.instanceDetailsTitle = gettext('Baremetal Instance Details');
    ctrl.instanceDetailsParagraphs = [
      // jscs:disable maximumLineLength
      gettext('A baremetal instance name is required and used to help you uniquely identify your baremetal instance in the dashboard.'),
      gettext('If you select an availability zone and plan to use the boot from volume option, make sure that the availability zone you select for the baremetal instance is the same availability zone where your bootable volume resides.')
    ...
    ctrl.instanceSourceParagraphs = [
      ...
      gettext('<li><b>Image</b>: This option uses an image to boot the baremetal instance.</li>'),
      gettext('<li><b>Baremetal Instance Snapshot</b>: This option uses a baremetal instance snapshot to boot the baremetal instance.</li>'),
      ...
      gettext('<li><b>Volume</b>: This option uses a volume that already exists. It does not create a new volume. You can choose to delete the volume on termination of the baremetal instance. <em>Note: when selecting Volume, you can only launch one baremetal instance.</em></li>'),
