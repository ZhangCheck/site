...
(function () {
  ...
  function LaunchInstanceSourceController($scope,
    ...
    ctrl.label = {
      ...
      appointHost: gettext('Appoint Host'),
      instance_count: gettext('Count'),
      selectHostOption: gettext('Select a computing node'),
      ...
      servergroup: gettext('Server Group'),
      noServerGroup: gettext('No Server Group'),
      chooseServerGroup: gettext('Select one')
    };
    ...
    var tableHeadCellsMap = {
      image: [
        { text: gettext('Name'), style: { width: '64%', 'padding-left': '10px' }, sortable: true, sortDefault: true },
    ...
    $scope.model.newInstanceSpec.server_group = "";
