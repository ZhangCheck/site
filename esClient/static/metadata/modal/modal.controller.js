...
(function () {
  ...
  function MetadataModalController(
    ...
    ctrl.context = {
      header: {
        aggregate_title: gettext('Update Aggregate Metadata'),
        flavor_title: gettext('Update Flavor Metadata'),
        image_title: gettext('Update Image Metadata'),
        instance_title: gettext('Update Instance Metadata'),
