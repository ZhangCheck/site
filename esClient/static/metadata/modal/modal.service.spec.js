...
(function () {
  ...
  describe('horizon.app.metadata.modal', function() {
    ...
    describe('service.modalservice', function() {
      ...
      beforeEach(module('horizon.app', function($provide) {
        $provide.constant('horizon.app.basePath', '/a/sample/path/');
      }));

      beforeEach(module('horizon.app.metadata', function($provide) {
        metadataService = jasmine.createSpyObj('metadataService', ['getMetadata', 'getNamespaces']);
        $provide.value('horizon.app.metadata.service', metadataService);
      }));

      beforeEach(module('horizon.app.metadata.modal'));

      beforeEach(inject(function($controller, $injector) {
        modalService = $injector.get('horizon.app.metadata.modal.service');
      }));
