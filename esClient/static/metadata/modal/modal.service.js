...
(function () {
  ...
  angular
    ...
    .factory('horizon.app.metadata.modal.service', modalService);

  modalService.$inject = [
    '$modal',
    'horizon.app.metadata.service',
    'horizon.app.metadata.modal.constants'
  ];
   ...
   * @name modalService
   */
  function modalService($modal, metadataService, modalConstants) {
    var service = {
      open: open
    };
    ...
    function open(resource, id, propertiesTarget) {
      ...
      var modalParams = {
        resolve: resolve,
        templateUrl: '/static/metadata/modal/modal.html'
      };
