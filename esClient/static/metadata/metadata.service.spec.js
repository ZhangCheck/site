...
(function () {
  ...
  describe('metadata.service', function () {
    ...
    beforeEach(module('horizon.app.metadata'));
    ...
    beforeEach(function() {
      module(function($provide) {
        $provide.value('horizon.openstack-service-api.nova', nova);
        $provide.value('horizon.openstack-service-api.glance', glance);
      });
    });
    ...
    beforeEach(inject(function($injector) {
      metadataService = $injector.get('horizon.app.metadata.service');
    }));
