...
(lib.微信图片_20170629132041 = function() {
	this.initialize(img.微信图片_20170629132041);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,948,1280);// helper functions:
...
(lib.Symbol1 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f().s("#33CCCC").ss(1,1,1).p("AAAkaIAAI1");
	...
	this.shape_1.graphics.f().s("#33CCCC").ss(1,1,1).p("ACdAAQAAB1gvBTQgtBThBAAQhAAAguhTQguhTAAh1QAAh0AuhTQAuhTBAAAQBBAAAtBTQAvBTAAB0g");
	this.shape_1.setTransform(0.2,0.4);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol1, new cjs.Rectangle(-16.4,-28.8,33.3,58.6), null);
...
(lib.test = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		this.addEventListener('click',function(e){
			that.lines.visible = !that.lines.visible;
		})
	}
	...
	// Layer 3
	this.lines = new lib.Symbol2();
	this.lines.parent = this;
	this.lines.setTransform(340.3,266.5,1,1,0,0,0,-0.3,0.3);

	this.timeline.addTween(cjs.Tween.get(this.lines).wait(1));

	// Layer 1
	this.instance = new lib.微信图片_20170629132041();
	this.instance.parent = this;
	this.instance.setTransform(-354,-903,1.519,1.519);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-79,-703,1439.8,1944.1);
// library properties:
lib.properties = {
	id: 'C8F31C17E165CC44A297C8641A1F2C4D',
	width: 550,
	height: 400,
	fps: 24,
	color: "#FFFFFF",
...
an.compositions['C8F31C17E165CC44A297C8641A1F2C4D'] = {
